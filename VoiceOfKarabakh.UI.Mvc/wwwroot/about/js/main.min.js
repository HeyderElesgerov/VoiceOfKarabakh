! function(t, e) { "function" == typeof define && define.amd ? define("jquery-bridget/jquery-bridget", ["jquery"], (function(i) { return e(t, i) })) : "object" == typeof module && module.exports ? module.exports = e(t, require("jquery")) : t.jQueryBridget = e(t, t.jQuery) }(window, (function(t, e) {
    ...
    function i(i, s, a) {
        ...
        }(a = a || e || t.jQuery) && (s.prototype.option || (s.prototype.option = function(t) { a.isPlainObject(t) && (this.options = a.extend(!0, this.options, t)) }), a.fn[i] = function(t) { if ("string" == typeof t) { var e = r.call(arguments, 1); return l(this, t, e) } return h(this, t), this }, n(a))
    }

    function n(t) {!t || t && t.bridget || (t.bridget = i) }
    var r = Array.prototype.slice,
        s = t.console,
        o = void 0 === s ? function() {} : function(t) { s.error(t) };
...
function(t, e) { "use strict"; "function" == typeof define && define.amd ? define("get-size/get-size", [], (function() { return e() })) : "object" == typeof module && module.exports ? module.exports = e() : t.getSize = e() }(window, (function() {
    ...
    function i() {
        if (!l) {
            ...
            s.appendChild(i);
            var o = e(i);
            n.isBoxSizeOuter = r = 200 == t(o.width), s.removeChild(i)
        }
    }
    ...
    function n(n) {
        if (i(), "string" == typeof n && (n = document.querySelector(n)), n && "object" == typeof n && n.nodeType) {
            var s = e(n);
            if ("none" == s.display) return function() { for (var t = { width: 0, height: 0, innerWidth: 0, innerHeight: 0, outerWidth: 0, outerHeight: 0 }, e = 0; e < a; e++) { t[o[e]] = 0 } return t }();
            var l = {};
            ...
            var p = l.paddingLeft + l.paddingRight,
                ...
                b = h && r,
                x = t(s.width);
            !1 !== x && (l.width = x + (b ? 0 : p + v));
            var w = t(s.height);
            return !1 !== w && (l.height = w + (b ? 0 : m + y)), l.innerWidth = l.width - (p + v), l.innerHeight = l.height - (m + y), l.outerWidth = l.width + g, l.outerHeight = l.height + _, l
        }
    }
    var r, s = "undefined" == typeof console ? function() {} : function(t) { console.error(t) },
...
function(t, e) { "function" == typeof define && define.amd ? define("fizzy-ui-utils/utils", ["desandro-matches-selector/matches-selector"], (function(i) { return e(t, i) })) : "object" == typeof module && module.exports ? module.exports = e(t, require("desandro-matches-selector")) : t.fizzyUIUtils = e(t, t.matchesSelector) }(window, (function(t, e) {
    ...
    i.makeArray = function(t) { return Array.isArray(t) ? t : null == t ? [] : "object" == typeof t && "number" == typeof t.length ? n.call(t) : [t] }, i.removeFrom = function(t, e) { var i = t.indexOf(e); - 1 != i && t.splice(i, 1) }, i.getParent = function(t, i) {
        ...
        t.prototype[e] = function() {
            ...
            var e = arguments,
                s = this;
            this[r] = setTimeout((function() { n.apply(s, e), delete s[r] }), i)
        }
    ...
    return i.htmlInit = function(e, n) {
        i.docReady((function() {
            ...
            h.forEach((function(t) {
                ...
                try { i = s && JSON.parse(s) } catch (e) { return void(r && r.error("Error parsing " + o + " on " + t.className + ": " + e)) }
                var a = new e(t, i);
                u && u.data(t, n, a)
            }))
        }))
...
function(t, e) {
    if ("function" == typeof define && define.amd) define("flickity/js/flickity", ["ev-emitter/ev-emitter", "get-size/get-size", "fizzy-ui-utils/utils", "./cell", "./slide", "./animate"], (function(i, n, r, s, o, a) { return e(t, i, n, r, s, o, a) }));
    ...
    function l(t, e) {
        ...
        if (i) {
            if (this.element = i, this.element.flickityGUID) { var r = d[this.element.flickityGUID]; return r.option(e), r }
    ...
    return p.setCellAlign = function() {
        ...
        if (this.options.contain && !this.options.wrapAround && this.cells.length) {
            ...
            this.slides.forEach((function(t) { r ? t.target = n * this.cellAlign : (t.target = Math.max(t.target, s), t.target = Math.min(t.target, o)) }), this)
        }
    ...
    }, p.getCellElements = function() { return this.cells.map((function(t) { return t.element })) }, p.getParentCell = function(t) { var e = this.getCell(t); return e || (t = n.getParent(t, ".flickity-slider > *"), this.getCell(t)) }, p.getAdjacentCellElements = function(t, e) {
    ...
    }, p.watchCSS = function() { this.options.watchCSS && (-1 != c(this.element, ":after").content.indexOf("flickity") ? this.activate() : this.deactivate()) }, p.onkeydown = function(t) {
...
function(t, e) { "function" == typeof define && define.amd ? define("flickity/js/drag", ["./flickity", "unidragger/unidragger", "fizzy-ui-utils/utils"], (function(i, n, r) { return e(t, i, n, r) })) : "object" == typeof module && module.exports ? module.exports = e(t, require("./flickity"), require("unidragger"), require("fizzy-ui-utils")) : t.Flickity = e(t, t.Flickity, t.Unidragger, t.fizzyUIUtils) }(window, (function(t, e, i, n) {
    ...
    return s.pointerDownFocus = function(t) { l[t.target.nodeName] || this.focus() }, s._pointerDownPreventDefault = function(t) {
        var e = "touchstart" == t.type,
            i = "touch" == t.pointerType,
            n = l[t.target.nodeName];
        e || i || n || t.preventDefault()
    }, s.hasDragStarted = function(t) { return Math.abs(t.x) > this.options.dragThreshold }, s.pointerUp = function(t, e) { delete this.isTouchScrolling, this.viewport.classList.remove("is-pointer-down"), this.dispatchEvent("pointerUp", t, [e]), this._dragPointerUp(t, e) }, s.pointerDone = function() { t.removeEventListener("scroll", this), delete this.pointerDownScroll }, s.dragStart = function(e, i) { this.isDraggable && (this.dragStartPosition = this.x, this.startAnimation(), t.removeEventListener("scroll", this), this.dispatchEvent("dragStart", e, [i])) }, s.pointerMove = function(t, e) {
        var i = this._dragPointerMove(t, e);
    ...
    }, s._getClosestResting = function(t, e, i) { for (var n = this.selectedIndex, r = 1 / 0, s = this.options.contain && !this.options.wrapAround ? function(t, e) { return t <= e } : function(t, e) { return t < e }; s(e, r) && (n += i, r = e, null !== (e = this.getSlideDistance(-t, n)));) e = Math.abs(e); return { distance: r, index: n - i } }, s.getSlideDistance = function(t, e) {
        var i = this.slides.length,
    ...
    return n.bindTap = function(t) { t && (this.unbindTap(), this.tapElement = t, this._bindStartEvent(t, !0)) }, n.unbindTap = function() { this.tapElement && (this._bindStartEvent(this.tapElement, !0), delete this.tapElement) }, n.pointerUp = function(i, n) {
        if (!this.isIgnoringMouseUp || "mouseup" != i.type) {
            var r = e.getPointerPoint(n),
                ...
                o = t.pageXOffset,
                a = t.pageYOffset;
            if (r.x >= s.left + o && r.x <= s.right + o && r.y >= s.top + a && r.y <= s.bottom + a && this.emitEvent("tap", [i, n]), "mouseup" != i.type) {
...
function(t, e) { "function" == typeof define && define.amd ? define("flickity/js/prev-next-button", ["./flickity", "tap-listener/tap-listener", "fizzy-ui-utils/utils"], (function(i, n, r) { return e(t, i, n, r) })) : "object" == typeof module && module.exports ? module.exports = e(t, require("./flickity"), require("tap-listener"), require("fizzy-ui-utils")) : e(t, t.Flickity, t.TapListener, t.fizzyUIUtils) }(window, (function(t, e, i, n) {
    ...
    r.prototype = Object.create(i.prototype), r.prototype._create = function() {
        ...
        var e = document.createElementNS(s, "path"),
            i = function(t) { return "string" == typeof t ? t : "M " + t.x0 + ",50 L " + t.x1 + "," + (t.y1 + 50) + " L " + t.x2 + "," + (t.y2 + 50) + " L " + t.x3 + ",50  L " + t.x2 + "," + (50 - t.y2) + " L " + t.x1 + "," + (50 - t.y1) + " Z" }(this.parent.options.arrowShape);
    ...
    }, r.prototype.destroy = function() { this.deactivate() }, n.extend(e.defaults, { prevNextButtons: !0, arrowShape: { x0: 10, x1: 60, y1: 50, x2: 70, y2: 40, x3: 30 } }), e.createMethods.push("_createPrevNextButtons");
    var o = e.prototype;
...
function(t, e) { "function" == typeof define && define.amd ? define("flickity/js/page-dots", ["./flickity", "tap-listener/tap-listener", "fizzy-ui-utils/utils"], (function(i, n, r) { return e(t, i, n, r) })) : "object" == typeof module && module.exports ? module.exports = e(t, require("./flickity"), require("tap-listener"), require("fizzy-ui-utils")) : e(t, t.Flickity, t.TapListener, t.fizzyUIUtils) }(window, (function(t, e, i, n) {
    ...
    }, r.prototype.removeDots = function(t) { this.dots.splice(this.dots.length - t, t).forEach((function(t) { this.holder.removeChild(t) }), this) }, r.prototype.updateSelected = function() { this.selectedDot && (this.selectedDot.className = "dot", this.selectedDot.removeAttribute("aria-current")), this.dots.length && (this.selectedDot = this.dots[this.parent.selectedIndex], this.selectedDot.className = "dot is-selected", this.selectedDot.setAttribute("aria-current", "step")) }, r.prototype.onTap = function(t) {
        var e = t.target;
        if ("LI" == e.nodeName) {
            this.parent.uiChange();
    ...
    }, r.prototype.destroy = function() { this.deactivate() }, e.PageDots = r, n.extend(e.defaults, { pageDots: !0 }), e.createMethods.push("_createPageDots");
    var s = e.prototype;
...
function(t, e) { "function" == typeof define && define.amd ? define("flickity/js/add-remove-cell", ["./flickity", "fizzy-ui-utils/utils"], (function(i, n) { return e(t, i, n) })) : "object" == typeof module && module.exports ? module.exports = e(t, require("./flickity"), require("fizzy-ui-utils")) : e(t, t.Flickity, t.fizzyUIUtils) }(window, (function(t, e, i) {
    ...
    return n.insert = function(t, e) {
        ...
        if (i && i.length) {
            ...
            e = void 0 === e ? n : e;
            var r = function(t) { var e = document.createDocumentFragment(); return t.forEach((function(t) { e.appendChild(t.element) })), e }(i),
                s = e == n;
...
function(t, e) { "function" == typeof define && define.amd ? define("flickity/js/lazyload", ["./flickity", "fizzy-ui-utils/utils"], (function(i, n) { return e(t, i, n) })) : "object" == typeof module && module.exports ? module.exports = e(t, require("./flickity"), require("fizzy-ui-utils")) : e(t, t.Flickity, t.fizzyUIUtils) }(window, (function(t, e, i) {
    ...
    var s = e.prototype;
    return s._createLazyload = function() { this.on("select", this.lazyLoad) }, s.lazyLoad = function() {
        ...
        if (t) {
            ...
            i.forEach((function(t) {
                var e = n(t);
                s = s.concat(e)
            })), s.forEach((function(t) { new r(t, this) }), this)
        }
...
function(t, e) { "function" == typeof define && define.amd ? define("flickity-as-nav-for/as-nav-for", ["flickity/js/index", "fizzy-ui-utils/utils"], e) : "object" == typeof module && module.exports ? module.exports = e(require("flickity"), require("fizzy-ui-utils")) : t.Flickity = e(t.Flickity, t.fizzyUIUtils) }(window, (function(t, e) {
    ...
    return i._createAsNavFor = function() {
        ...
        if (n && n != this) {
            this.navCompanion = n;
            var r = this;
            this.onNavCompanionSelect = function() { r.navCompanionSelect() }, n.on("select", this.onNavCompanionSelect), this.on("staticClick", this.onNavStaticClick), this.navCompanionSelect(!0)
        }
        ...
        if (this.navCompanion) {
            var e = this.navCompanion.selectedCells[0],
                ...
                r = Math.floor(function(t, e, i) { return (e - t) * i + t }(i, n, this.navCompanion.cellAlign));
...
function(t, e) { "use strict"; "function" == typeof define && define.amd ? define("imagesloaded/imagesloaded", ["ev-emitter/ev-emitter"], (function(i) { return e(t, i) })) : "object" == typeof module && module.exports ? module.exports = e(t, require("ev-emitter")) : t.imagesLoaded = e(t, t.EvEmitter) }("undefined" != typeof window ? window : this, (function(t, e) {
    ...
    return n.prototype.addElementBackgroundImages = function(t) {
        ...
        (e = e || t.jQuery) && ((o = e).fn.imagesLoaded = function(t, e) { return new n(this, t, e).jqDeferred.promise(o(this)) })
...
function(t, e) { "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.inView = e() : t.inView = e() }(this, (function() {
    return function(t) {
        ...
        "use strict";
        var n = function(t) { return t && t.__esModule ? t : { default: t } }(i(2));
        t.exports = n.default
    }, function(t, e) { t.exports = function(t) { var e = typeof t; return null != t && ("object" == e || "function" == e) } }, function(t, e, i) {
        "use strict";
        ...
        e.default = function() {
            if ("undefined" != typeof window) {
                var t = { history: [] },
                    e = { offset: {}, threshold: 0, test: o.inViewport },
                    i = (0, r.default)((function() { t.history.forEach((function(e) { t[e].check() })) }), 100);
                ["scroll", "resize", "load"].forEach((function(t) { return addEventListener(t, i) })), window.MutationObserver && addEventListener("DOMContentLoaded", (function() { new MutationObserver(i).observe(document.body, { attributes: !0, childList: !0, subtree: !0 }) }));
                var n = function(i) { if ("string" == typeof i) { var n = [].slice.call(document.querySelectorAll(i)); return t.history.indexOf(i) > -1 ? t[i].elements = n : (t[i] = (0, s.default)(n, e), t.history.push(i)), t[i] } };
                return n.offset = function(t) { if (void 0 === t) return e.offset; var i = function(t) { return "number" == typeof t }; return ["top", "right", "bottom", "left"].forEach(i(t) ? function(i) { return e.offset[i] = t } : function(n) { return i(t[n]) ? e.offset[n] = t[n] : null }), e.offset }, n.threshold = function(t) { return "number" == typeof t && t >= 0 && t <= 1 ? e.threshold = t : e.threshold }, n.test = function(t) { return "function" == typeof t ? e.test = t : e.test }, n.is = function(t) { return e.test(t, e) }, n.offset(0), n
            }
        }()
    }, function(t, e) {
        "use strict";
        ...
        var i = function() {
            ...
            n = function() {
                function t(e, i) {
                    (function(t, e) { if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function") })(this, t), this.options = i, this.elements = e, this.current = [], this.handlers = { enter: [], exit: [] }, this.singles = { enter: [], exit: [] }
                }
                return i(t, [{
                    key: "check",
                    value: function() {
                ...
                }, { key: "on", value: function(t, e) { return this.handlers[t].push(e), this } }, { key: "once", value: function(t, e) { return this.singles[t].unshift(e), this } }, { key: "emit", value: function(t, e) { for (; this.singles[t].length;) this.singles[t].pop()(e); for (var i = this.handlers[t].length; --i > -1;) this.handlers[t][i](e); return this } }]), t
            }();
        e.default = function(t, e) { return new n(t, e) }
    }, function(t, e) {
        "use strict";
        Object.defineProperty(e, "__esModule", { value: !0 }), e.inViewport = function(t, e) {
            var i = t.getBoundingClientRect(),
                ...
                d = e.threshold * a,
                p = e.threshold * l;
            return h > e.offset.top + p && c > e.offset.right + d && u > e.offset.bottom + p && f > e.offset.left + d
        }
    }, function(t, e) {
        (function(e) {
        ...
        t.exports = function(t, e, i) {
            function h(e) {
                var i = m,
                    n = g;
                return m = g = void 0, x = e, v = t.apply(n, i)
            }

            function c(t) { return x = t, y = setTimeout(f, e), w ? h(t) : v }

            function u(t) { var i = t - b; return void 0 === b || i >= e || i < 0 || T && t - x >= _ }

            function f() { var t = r(); return u(t) ? d(t) : void(y = setTimeout(f, function(t) { var i = e - (t - b); return T ? l(i, _ - (t - x)) : i }(t))) }

            function d(t) { return y = void 0, S && m ? h(t) : (m = g = void 0, v) }

            function p() {
                var t = r(),
                    i = u(t);
                if (m = arguments, g = this, b = t, i) { if (void 0 === y) return c(b); if (T) return y = setTimeout(f, e), h(b) }
                return void 0 === y && (y = setTimeout(f, e)), v
            }
            var m, g, _, v, y, b, x = 0,
                w = !1,
                T = !1,
            ...
            return e = s(e) || 0, n(i) && (w = !!i.leading, _ = (T = "maxWait" in i) ? a(s(i.maxWait) || 0, e) : _, S = "trailing" in i ? !!i.trailing : S), p.cancel = function() { void 0 !== y && clearTimeout(y), x = 0, m = b = g = y = void 0 }, p.flush = function() { return void 0 === y ? v : d(r()) }, p
        }
    }, function(t, e, i) {
        var n = i(6);
    ...
    }, function(t, e) { t.exports = function(t) { return t } }])
})),
function(t) {
    t.fn.ripple = function(e) {
        if (this.length > 1) return this.each((function(i, n) { t(n).ripple(e) }));
        if (e = e || {}, this.off(".ripple").data("unbound", !0), e.unbind) return this;
        var i = function() { return f && !f.data("unbound") };
        this.addClass("legitRipple").removeData("unbound").on("tap.ripple", (function(e) { i() || (f = t(this), y(e.coords)) })).on("dragstart.ripple", (function(t) { g.allowDragging || t.preventDefault() })), t(document).on("move.ripple", (function(t) { i() && b(t.coords) })).on("end.ripple", (function() { i() && x() })), t(window).on("scroll.ripple", (function(t) { i() && x() }));
        var n, r, s, o, a = function(t) { return !!t.type.match(/^touch/) },
            l = function(t, e) { return a(t) && (t = h(t.originalEvent.touches, e)), [t.pageX, t.pageY] },
            h = function(e, i) { return t.makeArray(e).filter((function(t, e) { return t.identifier == i }))[0] },
            c = 0,
            u = function(t) { "touchstart" == t.type && (c = 3), "scroll" == t.type && (c = 0); var e = c && !a(t); return e && c--, !e };
        this.on("mousedown.ripple touchstart.ripple", (function(e) { u(e) && (n = a(e) ? e.originalEvent.changedTouches[0].identifier : -1, r = t(this), s = t.Event("tap", { coords: l(e, n) }), ~n ? o = setTimeout((function() { r.trigger(s), o = null }), g.touchDelay) : r.trigger(s)) })), t(document).on("mousemove.ripple touchmove.ripple mouseup.ripple touchend.ripple touchcancel.ripple", (function(e) {
            var i = e.type.match(/move/);
            o && !i && (clearTimeout(o), o = null, r.trigger(s)), u(e) && (a(e) ? h(e.originalEvent.changedTouches, n) : !~n) && t(this).trigger(i ? t.Event("move", { coords: l(e, n) }) : "end")
        })).on("contextmenu.ripple", (function(t) { u(t) })).on("touchmove", (function() { clearTimeout(o), o = null }));
        var f, d, p, m, g = {},
            _ = 0,
            v = function() {
                var i = { fixedPos: null, get dragging() { return !g.fixedPos }, get adaptPos() { return g.dragging }, get maxDiameter() { return Math.sqrt(Math.pow(p[0], 2) + Math.pow(p[1], 2)) / f.outerWidth() * Math.ceil(g.adaptPos ? 100 : 200) + "%" }, scaleMode: "fixed", template: null, allowDragging: !1, touchDelay: 100, callback: null };
                t.each(i, (function(t, i) { g[t] = t in e ? e[t] : i }))
            },
            y = function(e) {
                p = [f.outerWidth(), f.outerHeight()], v(), m = e, d = t("<span/>").addClass("legitRipple-ripple"), g.template && d.append(("object" == typeof g.template ? g.template : f.children(".legitRipple-template").last()).clone().removeClass("legitRipple-template")).addClass("legitRipple-custom"), d.appendTo(f), w(e, !1);
                var i = d.css("transition-duration").split(","),
                    n = [5.5 * parseFloat(i[0]) + "s"].concat(i.slice(1)).join(",");
                d.css("transition-duration", n).css("width", g.maxDiameter), d.on("transitionend webkitTransitionEnd oTransitionEnd", (function() { t(this).data("oneEnded") ? t(this).off().remove() : t(this).data("oneEnded", !0) }))
            },
            b = function(t) {
                var e;
                if (_++, "proportional" === g.scaleMode) {
                    var i = Math.pow(_, _ / 100 * .6);
                    e = i > 40 ? 40 : i
                } else if ("fixed" == g.scaleMode && Math.abs(t[1] - m[1]) > 6) return void x();
                w(t, e)
            },
            x = function() { d.css("width", d.css("width")).css("transition", "none").css("transition", "").css("width", d.css("width")).css("width", g.maxDiameter).css("opacity", "0"), f = null, _ = 0 },
            w = function(e, i) {
                var n = [],
                    r = !0 === g.fixedPos ? [.5, .5] : [(g.fixedPos ? g.fixedPos[0] : e[0] - f.offset().left) / p[0], (g.fixedPos ? g.fixedPos[1] : e[1] - f.offset().top) / p[1]],
                    s = [.5 - r[0], .5 - r[1]],
                    o = [100 / parseFloat(g.maxDiameter), 100 / parseFloat(g.maxDiameter) * (p[1] / p[0])],
                    a = [s[0] * o[0], s[1] * o[1]],
                    l = g.dragging || 0 === _;
                if (l && "inline" == f.css("display")) {
                    var h = t("<span/>").text("Hi!").css("font-size", 0).prependTo(f),
                        c = h.offset().left;
                    h.remove(), n = [e[0] - c + "px", e[1] - f.offset().top + "px"]
                }
                l && d.css("left", n[0] || 100 * r[0] + "%").css("top", n[1] || 100 * r[1] + "%"), d.css("transform", "translate3d(-50%, -50%, 0)" + (g.adaptPos ? "translate3d(" + 100 * a[0] + "%, " + 100 * a[1] + "%, 0)" : "") + (i ? "scale(" + i + ")" : "")), g.callback && g.callback(f, d, r, g.maxDiameter)
            };
        return this
    }, t.ripple = function(e) { t.each(e, (function(e, i) { t(e).ripple(i) })) }, t.ripple.destroy = function() { t(".legitRipple").removeClass("legitRipple").add(window).add(document).off(".ripple"), t(".legitRipple-ripple").remove() }
}(jQuery);
var _gsScope, _extends = Object.assign || function(t) { for (var e = 1; e < arguments.length; e++) { var i = arguments[e]; for (var n in i) Object.prototype.hasOwnProperty.call(i, n) && (t[n] = i[n]) } return t },
...
if (function(t, e) { "object" === ("undefined" == typeof exports ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : t.LazyLoad = e() }(this, (function() {
        "use strict";
        var t = function(t, e) { return t.getAttribute("data-" + e) },
            e = function(e) { return e.filter((function(e) { return !t(e, "was-processed") })) },
            i = function(t, e) {
                var i, n = new t(e);
            ...
            n = function(e, i) {
                ...
                if ("IMG" === s) {
                    ! function(e, i) {
                        var n = i.data_srcset,
                            r = e.parentNode;
                        if (r && "PICTURE" === r.tagName)
                            for (var s, o = 0; s = r.children[o]; o += 1)
                                if ("SOURCE" === s.tagName) {
                                    var a = t(s, n);
                ...
                "IFRAME" !== s ? o && (e.style.backgroundImage = 'url("' + o + '")') : o && e.setAttribute("src", o)
            },
            r = "undefined" != typeof window,
            s = r && "IntersectionObserver" in window,
            o = r && "classList" in document.createElement("p"),
            a = function(t, e) { o ? t.classList.add(e) : t.className += (t.className ? " " : "") + e },
            l = function(t, e) { t && t(e) },
            h = function(t, e, i) { t.removeEventListener("load", e), t.removeEventListener("error", i) },
            c = function(t, e, i) {
                var n = t.target;
                (function(t, e) { o ? t.classList.remove(e) : t.className = t.className.replace(new RegExp("(^|\\s+)" + e + "(\\s+|$)"), " ").replace(/^\s+/, "").replace(/\s+$/, "") })(n, i.class_loading), a(n, e ? i.class_loaded : i.class_error), l(e ? i.callback_load : i.callback_error, n)
            },
            u = function(t, e) {
                l(e.callback_enter, t), ["IMG", "IFRAME"].indexOf(t.tagName) > -1 && (function(t, e) {
                        var i = function i(r) { c(r, !0, e), h(t, i, n) },
                            n = function n(r) { c(r, !1, e), h(t, i, n) };
                        t.addEventListener("load", i), t.addEventListener("error", n)
                    }(t, e), a(t, e.class_loading)), n(t, e),
                    function(t, e, i) { t.setAttribute("data-" + e, i) }(t, "was-processed", !0), l(e.callback_set, t)
            },
            f = function(t, e) { this._settings = function(t) { var e = { elements_selector: "img", container: document, threshold: 300, data_src: "src", data_srcset: "srcset", class_loading: "loading", class_loaded: "loaded", class_error: "error", callback_load: null, callback_error: null, callback_set: null, callback_enter: null }; return _extends({}, e, t) }(t), this._setObserver(), this.update(e) };
        f.prototype = {
                ...
                if (s) {
                    ...
                    this._observer = new IntersectionObserver((function(i) {
                        i.forEach((function(e) {
                            if (function(t) { return t.isIntersecting || t.intersectionRatio > 0 }(e)) {
                                var i = e.target;
                                u(i, t._settings), t._observer.unobserve(i)
                            }
            ...
            update: function(t) {
                ...
                this._elements = e(Array.prototype.slice.call(r)), this._observer ? this._elements.forEach((function(t) { i._observer.observe(t) })) : (this._elements.forEach((function(t) { u(t, n) })), this._elements = e(this._elements))
            },
            destroy: function() {
                var t = this;
                this._observer && (e(this._elements).forEach((function(e) { t._observer.unobserve(e) })), this._observer = null), this._elements = null, this._settings = null
            }
        };
    ...
    })), function(t) { "function" == typeof define && define.amd ? define(["jquery"], t) : "object" == typeof module && "object" == typeof module.exports ? t(require("jquery")) : t(jQuery) }((function(t) {
        t.timeago = function(e) { return e instanceof Date ? r(e) : r("string" == typeof e ? t.timeago.parse(e) : "number" == typeof e ? new Date(e) : t.timeago.datetime(e)) };
        var e = t.timeago;
        t.extend(t.timeago, {
            settings: { refreshMillis: 6e4, allowPast: !0, allowFuture: !1, localeTitle: !1, cutoff: 0, autoDispose: !0, strings: { prefixAgo: null, prefixFromNow: null, suffixAgo: "ago", suffixFromNow: "from now", inPast: "any moment now", seconds: "less than a minute", minute: "about a minute", minutes: "%d minutes", hour: "about an hour", hours: "about %d hours", day: "a day", days: "%d days", month: "about a month", months: "%d months", year: "about a year", years: "%d years", wordSeparator: " ", numbers: [] } },
            inWords: function(e) {
                ...
                var u = s < 45 && c(i.seconds, Math.round(s)) || s < 90 && c(i.minute, 1) || o < 45 && c(i.minutes, Math.round(o)) || o < 90 && c(i.hour, 1) || a < 24 && c(i.hours, Math.round(a)) || a < 42 && c(i.day, 1) || l < 30 && c(i.days, Math.round(l)) || l < 45 && c(i.month, 1) || l < 365 && c(i.months, Math.round(l / 30)) || h < 1.5 && c(i.year, 1) || c(i.years, Math.round(h)),
                    f = i.wordSeparator || "";
                return void 0 === i.wordSeparator && (f = " "), t.trim([n, u, r].join(f))
            },
            parse: function(e) { var i = t.trim(e); return i = (i = (i = (i = (i = i.replace(/\.\d+/, "")).replace(/-/, "/").replace(/-/, "/")).replace(/T/, " ").replace(/Z/, " UTC")).replace(/([\+\-]\d\d)\:?(\d\d)/, " $1$2")).replace(/([\+\-]\d\d)$/, " $100"), new Date(i) },
            datetime: function(i) { var n = e.isTime(i) ? t(i).attr("datetime") : t(i).attr("title"); return e.parse(n) },
            isTime: function(e) { return "time" === t(e).get(0).tagName.toLowerCase() }
        });
        var i = {
            init: function() {
                i.dispose.call(this);
                var r = t.proxy(n, this);
                r();
                var s = e.settings;
                s.refreshMillis > 0 && (this._timeagoInterval = setInterval(r, s.refreshMillis))
            },
            update: function(i) {
                var r = i instanceof Date ? i : e.parse(i);
                t(this).data("timeago", { datetime: r }), e.settings.localeTitle && t(this).attr("title", r.toLocaleString()), n.apply(this)
            },
            updateFromDOM: function() { t(this).data("timeago", { datetime: e.parse(e.isTime(this) ? t(this).attr("datetime") : t(this).attr("title")) }), n.apply(this) },
            dispose: function() { this._timeagoInterval && (window.clearInterval(this._timeagoInterval), this._timeagoInterval = null) }
        };
        ...
        function n() {
            ...
            var n = function(i) {
                if (!(i = t(i)).data("timeago")) {
                    ...
                    var n = t.trim(i.text());
                    e.settings.localeTitle ? i.attr("title", i.data("timeago").datetime.toLocaleString()) : !(n.length > 0) || e.isTime(i) && i.attr("title") || i.attr("title", n)
                }
                return i.data("timeago")
            }(this);
            return isNaN(n.datetime) || (0 === i.cutoff || Math.abs(s(n.datetime)) < i.cutoff ? t(this).text(r(n.datetime)) : t(this).attr("title").length > 0 && t(this).text(t(this).attr("title"))), this
        }

        function r(t) { return e.inWords(s(t)) }

        function s(t) { return (new Date).getTime() - t.getTime() }
        t.fn.timeago = function(t, e) { var n = t ? i[t] : i.init; if (!n) throw new Error("Unknown function name '" + t + "' for timeago"); return this.each((function() { n.call(this, e) })), this }, document.createElement("abbr"), document.createElement("time")
    })), function(t) {
        var e = function(t) { return t.split("").reverse().join("") },
            i = {
        ...
        t.Tween && t.Tween.propHooks ? t.Tween.propHooks.number = { set: n } : t.fx.step.number = n, t.animateNumber = {
            numberStepFactories: {
                append: function(e) {
                    return function(i, n) {
                        var r = Math.floor(i);
                        t(n.elem).prop("number", i).text(r + e)
                    }
                },
                separator: function(i, n, r) {
                    return i = i || " ", n = n || 3, r = r || "",
                        function(s, o) {
                            var a = 0 > s,
                                l = Math.floor((a ? -1 : 1) * s).toString(),
                                h = t(o.elem);
                            if (l.length > n) {
                                for (var c, u, f, d = l, p = n, m = d.split("").reverse(), g = (l = [], 0), _ = Math.ceil(d.length / p); g < _; g++) {
                                    for (c = "", f = 0; f < p && (u = g * p + f) !== d.length; f++) c += m[u];
                                    l.push(c)
                                }
                                d = l.length - 1, p = e(l[d]), l[d] = e(parseInt(p, 10).toString()), l = l.join(i), l = e(l)
                            }
                            h.prop("number", s).text((a ? "-" : "") + l + r)
                        }
                }
            }
        }, t.fn.animateNumber = function() {
            for (var e = arguments[0], n = t.extend({}, i, e), r = t(this), s = [n], o = 1, a = arguments.length; o < a; o++) s.push(arguments[o]);
            if (e.numberStep) {
                var l = this.each((function() { this._animateNumberSetter = e.numberStep })),
                    h = n.complete;
                n.complete = function() { l.each((function() { delete this._animateNumberSetter })), h && h.apply(this, arguments) }
            }
        ...
        "use strict";
        var t, e, i, n, r, s, o, a, l, h, c, u, f, d, p, m;
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], (function(t, e, i) {
                var n = function(t) {
                    ...
                    s = function(t, e, n) { i.call(this, t, e, n), this._cycle = 0, this._yoyo = !0 === this.vars.yoyo || !!this.vars.yoyoEase, this._repeat = this.vars.repeat || 0, this._repeatDelay = this.vars.repeatDelay || 0, this._repeat && this._uncache(!0), this.render = s.prototype.render },
                    o = 1e-10,
                    a = i._internals,
                    l = a.isSelector,
                    h = a.isArray,
                ...
                s.version = "1.20.4", c.constructor = s, c.kill()._gc = !1, s.killTweensOf = s.killDelayedCallsTo = i.killTweensOf, s.getTweensOf = i.getTweensOf, s.lagSmoothing = i.lagSmoothing, s.ticker = i.ticker, s.render = i.render, c.invalidate = function() { return this._yoyo = !0 === this.vars.yoyo || !!this.vars.yoyoEase, this._repeat = this.vars.repeat || 0, this._repeatDelay = this.vars.repeatDelay || 0, this._yoyoEase = null, this._uncache(!0), i.prototype.invalidate.call(this) }, c.updateTo = function(t, e) {
                ...
                }, s.to = function(t, e, i) { return new s(t, e, i) }, s.from = function(t, e, i) { return i.runBackwards = !0, i.immediateRender = 0 != i.immediateRender, new s(t, e, i) }, s.fromTo = function(t, e, i, n) { return n.startAt = i, n.immediateRender = 0 != n.immediateRender && 0 != i.immediateRender, new s(t, e, n) }, s.staggerTo = s.allTo = function(t, e, o, a, c, f, d) {
                    a = a || 0;
                    var p, m, g, _, v = 0,
                        y = [],
                        b = function() { o.onComplete && o.onComplete.apply(o.onCompleteScope || this, arguments), c.apply(d || o.callbackScope || this, f || u) },
                        x = o.cycle,
                    ...
                    for (h(t) || ("string" == typeof t && (t = i.selector(t) || t), l(t) && (t = n(t))), t = t || [], 0 > a && ((t = n(t)).reverse(), a *= -1), p = t.length - 1, g = 0; p >= g; g++) {
                        ...
                        if (x && (r(m, t, g), null != m.duration && (e = m.duration, delete m.duration)), w) {
                            for (_ in w = m.startAt = {}, o.startAt) w[_] = o.startAt[_];
                            r(m.startAt, t, g)
                        }
                        m.delay = v + (m.delay || 0), g === p && c && (m.onComplete = b), y[g] = new s(t[g], e, m), v += a
                    }
                    return y
                }, s.staggerFrom = s.allFrom = function(t, e, i, n, r, o, a) { return i.runBackwards = !0, i.immediateRender = 0 != i.immediateRender, s.staggerTo(t, e, i, n, r, o, a) }, s.staggerFromTo = s.allFromTo = function(t, e, i, n, r, o, a, l) { return n.startAt = i, n.immediateRender = 0 != n.immediateRender && 0 != i.immediateRender, s.staggerTo(t, e, n, r, o, a, l) }, s.delayedCall = function(t, e, i, n, r) { return new s(e, 0, { delay: t, onComplete: e, onCompleteParams: i, callbackScope: n, onReverseComplete: e, onReverseCompleteParams: i, immediateRender: !1, useFrames: r, overwrite: 0 }) }, s.set = function(t, e) { return new s(t, 0, e) }, s.isTweening = function(t) { return i.getTweensOf(t, !0).length > 0 };
                var f = function(t, e) { for (var n = [], r = 0, s = t._first; s;) s instanceof i ? n[r++] = s : (e && (n[r++] = s), r = (n = n.concat(f(s, e))).length), s = s._next; return n },
                    d = s.getAllTweens = function(e) { return f(t._rootTimeline, e).concat(f(t._rootFramesTimeline, e)) };
                ...
                var p = function(t, i, n, r) { i = !1 !== i, n = !1 !== n; for (var s, o, a = d(r = !1 !== r), l = i && n && r, h = a.length; --h > -1;) o = a[h], (l || o instanceof e || (s = o.target === o.vars.onComplete) && n || i && !s) && o.paused(t) };
                ...
                }, c.progress = function(t, e) { return arguments.length ? this.totalTime(this.duration() * (this._yoyo && 0 != (1 & this._cycle) ? 1 - t : t) + this._cycle * (this._duration + this._repeatDelay), e) : this._time / this.duration() }, c.totalProgress = function(t, e) { return arguments.length ? this.totalTime(this.totalDuration() * t, e) : this._totalTime / this.totalDuration() }, c.time = function(t, e) { return arguments.length ? (this._dirty && this.totalDuration(), t > this._duration && (t = this._duration), this._yoyo && 0 != (1 & this._cycle) ? t = this._duration - t + this._cycle * (this._duration + this._repeatDelay) : 0 !== this._repeat && (t += this._cycle * (this._duration + this._repeatDelay)), this.totalTime(t, e)) : this._time }, c.duration = function(e) { return arguments.length ? t.prototype.duration.call(this, e) : this._duration }, c.totalDuration = function(t) { return arguments.length ? -1 === this._repeat ? this : this.duration((t - this._repeat * this._repeatDelay) / (this._repeat + 1)) : (this._dirty && (this._totalDuration = -1 === this._repeat ? 999999999999 : this._duration * (this._repeat + 1) + this._repeatDelay * this._repeat, this._dirty = !1), this._totalDuration) }, c.repeat = function(t) { return arguments.length ? (this._repeat = t, this._uncache(!0)) : this._repeat }, c.repeatDelay = function(t) { return arguments.length ? (this._repeatDelay = t, this._uncache(!0)) : this._repeatDelay }, c.yoyo = function(t) { return arguments.length ? (this._yoyo = t, this) : this._yoyo }, s
                ...
                var n = function(t) {
                    ...
                    g = n.prototype = new e;
                return n.version = "1.20.4", g.constructor = n, g.kill()._gc = g._forcingPlayhead = g._hasPause = !1, g.to = function(t, e, n, r) { var s = n.repeat && u.TweenMax || i; return e ? this.add(new s(t, e, n), r) : this.set(t, n, r) }, g.from = function(t, e, n, r) { return this.add((n.repeat && u.TweenMax || i).from(t, e, n), r) }, g.fromTo = function(t, e, n, r, s) { var o = r.repeat && u.TweenMax || i; return e ? this.add(o.fromTo(t, e, n, r), s) : this.set(t, r, s) }, g.staggerTo = function(t, e, r, s, o, l, h, c) {
                    var u, p, g = new n({ onComplete: l, onCompleteParams: h, callbackScope: c, smoothChildTiming: this.smoothChildTiming }),
                        _ = r.cycle;
                    for ("string" == typeof t && (t = i.selector(t) || t), a(t = t || []) && (t = m(t)), 0 > (s = s || 0) && ((t = m(t)).reverse(), s *= -1), p = 0; p < t.length; p++)(u = f(r)).startAt && (u.startAt = f(u.startAt), u.startAt.cycle && d(u.startAt, t, p)), _ && (d(u, t, p), null != u.duration && (e = u.duration, delete u.duration)), g.to(t[p], e, u, p * s);
                    return this.add(g, o)
                }, g.staggerFrom = function(t, e, i, n, r, s, o, a) { return i.immediateRender = 0 != i.immediateRender, i.runBackwards = !0, this.staggerTo(t, e, i, n, r, s, o, a) }, g.staggerFromTo = function(t, e, i, n, r, s, o, a, l) { return n.startAt = i, n.immediateRender = 0 != n.immediateRender && 0 != i.immediateRender, this.staggerTo(t, e, n, r, s, o, a, l) }, g.call = function(t, e, n, r) { return this.add(i.delayedCall(0, t, e, n), r) }, g.set = function(t, e, n) { return n = this._parseTimeOrLabel(n, 0, !0), null == e.immediateRender && (e.immediateRender = n === this._time && !this._paused), this.add(new i(t, 0, e), n) }, n.exportRoot = function(t, e) {
                    null == (t = t || {}).smoothChildTiming && (t.smoothChildTiming = !0);
                    var r, s, o, a, l = new n(t),
                        h = l._timeline;
                    for (null == e && (e = !0), h._remove(l, !0), l._startTime = 0, l._rawPrevTime = l._time = l._totalTime = h._time, o = h._first; o;) a = o._next, e && o instanceof i && o.target === o.vars.onComplete || (0 > (s = o._startTime - o._delay) && (r = 1), l.add(o, s)), o = a;
                    return h.add(l, 0), r && l.totalDuration(), l
                }, g.add = function(r, s, o, a) {
                    var h, c, u, f, d, p;
                    if ("number" != typeof s && (s = this._parseTimeOrLabel(s, 0, !0, r)), !(r instanceof t)) {
                        if (r instanceof Array || r && r.push && l(r)) { for (o = o || "normal", a = a || 0, h = s, c = r.length, u = 0; c > u; u++) l(f = r[u]) && (f = new n({ tweens: f })), this.add(f, h), "string" != typeof f && "function" != typeof f && ("sequence" === o ? h = f._startTime + f.totalDuration() / f._timeScale : "start" === o && (f._startTime -= f.delay())), h += a; return this._uncache(!0) }
                    ...
                    var n, s, o, a, l, u, f, d = this._time,
                        ...
                        g = this._timeScale,
                        _ = this._paused;
                    if (d !== this._time && (t += this._time - d), t >= p - 1e-7 && t >= 0) this._totalTime = this._time = p, this._reversed || this._hasPausedChild() || (s = !0, a = "onComplete", l = !!this._timeline.autoRemoveChildren, 0 === this._duration && (0 >= t && t >= -1e-7 || this._rawPrevTime < 0 || this._rawPrevTime === r) && this._rawPrevTime !== t && this._first && (l = !0, this._rawPrevTime > r && (a = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r, t = p + 1e-4;
                    else if (1e-7 > t)
                    ...
                    return !1
                }, g.getChildren = function(t, e, n, r) { r = r || -9999999999; for (var s = [], o = this._first, a = 0; o;) o._startTime < r || (o instanceof i ? !1 !== e && (s[a++] = o) : (!1 !== n && (s[a++] = o), !1 !== t && (a = (s = s.concat(o.getChildren(!0, e, n))).length))), o = o._next; return s }, g.getTweensOf = function(t, e) {
                    var n, r, s = this._gc,
                        o = [],
                        a = 0;
                ...
                }, g._kill = function(t, e) { if (!t && !e) return this._enabled(!1, !1); for (var i = e ? this.getTweensOf(e) : this.getChildren(!0, !0, !1), n = i.length, r = !1; --n > -1;) i[n]._kill(t, e) && (r = !0); return r }, g.clear = function(t) {
                ...
                var n = function(e) { t.call(this, e), this._repeat = this.vars.repeat || 0, this._repeatDelay = this.vars.repeatDelay || 0, this._cycle = 0, this._yoyo = !0 === this.vars.yoyo, this._dirty = !0 },
                    ...
                    c = n.prototype = new t;
                return c.constructor = n, c.kill()._gc = !1, n.version = "1.20.4", c.invalidate = function() { return this._yoyo = !0 === this.vars.yoyo, this._repeat = this.vars.repeat || 0, this._repeatDelay = this.vars.repeatDelay || 0, this._uncache(!0), t.prototype.invalidate.call(this) }, c.addCallback = function(t, i, n, r) { return this.add(e.delayedCall(0, t, n, r), i) }, c.removeCallback = function(t, e) {
                    if (t)
                    ...
                    i = i || {};
                    var n, r, s, o = { ease: h, useFrames: this.usesFrames(), immediateRender: !1, lazy: !1 },
                        a = i.repeat && l.TweenMax || e;
                    for (r in i) o[r] = i[r];
                    return o.time = this._parseTimeOrLabel(t), n = Math.abs(Number(o.time) - this._time) / this._timeScale || .001, s = new a(this, n, o), o.onStart = function() { s.target.paused(!0), s.vars.time === s.target.time() || n !== s.duration() || s.isFromTo || s.duration(Math.abs(s.vars.time - s.target.time()) / s.target._timeScale).render(s.time(), !0, !0), i.onStart && i.onStart.apply(i.onStartScope || i.callbackScope || s, i.onStartParams || []) }, s
                    ...
                    this._gc && this._enabled(!0, !1);
                    var n, s, l, h, c, u, f, d, p = this._time,
                        ...
                        x = this._paused,
                        w = this._cycle;
                    if (p !== this._time && (t += this._time - p), t >= m - 1e-7 && t >= 0) this._locked || (this._totalTime = m, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (s = !0, h = "onComplete", c = !!this._timeline.autoRemoveChildren, 0 === this._duration && (0 >= t && t >= -1e-7 || 0 > b || b === r) && b !== t && this._first && (c = !0, b > r && (h = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r, this._yoyo && 0 != (1 & this._cycle) ? this._time = t = 0 : (this._time = g, t = g + 1e-4);
                    else if (1e-7 > t)
                        if (this._locked || (this._totalTime = this._cycle = 0), this._time = 0, (0 !== p || 0 === g && b !== r && (b > 0 || 0 > t && b >= 0) && !this._locked) && (h = "onReverseComplete", s = this._reversed), 0 > t) this._active = !1, this._timeline.autoRemoveChildren && this._reversed ? (c = s = !0, h = "onReverseComplete") : b >= 0 && this._first && (c = !0), this._rawPrevTime = t;
                        else {
                    ...
                    if (this._cycle !== w && !this._locked) {
                        var T = this._yoyo && 0 != (1 & w),
                            ...
                            k = this._rawPrevTime,
                            E = this._time;
                        if (this._totalTime = w * g, this._cycle < w ? T = !T : this._totalTime += g, this._time = p, this._rawPrevTime = 0 === g ? b - 1e-4 : b, this._cycle = w, this._locked = !0, p = T ? 0 : g, this.render(p, e, 0 === g), e || this._gc || this.vars.onRepeat && (this._cycle = P, this._locked = !1, this._callback("onRepeat")), p !== this._time) return;
                        if (S && (this._cycle = w, this._locked = !0, p = T ? g + 1e-4 : -1e-4, this.render(p, !0, !1)), this._locked = !1, this._paused && !x) return;
                        this._time = E, this._totalTime = C, this._cycle = P, this._rawPrevTime = k
                    }
                    if (this._time !== p && this._first || i || c || f) {
                        if (this._initted || (this._initted = !0), this._active || !this._paused && this._totalTime !== _ && t > 0 && (this._active = !0), 0 === _ && this.vars.onStart && (0 === this._totalTime && this._totalDuration || e || this._callback("onStart")), (d = this._time) >= p)
                        ...
                        this._onUpdate && (e || (o.length && a(), this._callback("onUpdate"))), h && (this._locked || this._gc || (v === this._startTime || y !== this._timeScale) && (0 === this._time || m >= this.totalDuration()) && (s && (o.length && a(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[h] && this._callback(h)))
                    } else _ !== this._totalTime && this._onUpdate && (e || this._callback("onUpdate"))
            ...
            }), !0), t = 180 / Math.PI, e = [], i = [], n = [], r = {}, s = _gsScope._gsDefine.globals, o = function(t, e, i, n) { i === n && (i = n - (n - e) / 1e6), t === e && (e = t + (i - t) / 1e6), this.a = t, this.b = e, this.c = i, this.d = n, this.da = n - t, this.ca = i - t, this.ba = e - t }, a = function(t, e, i, n) {
                var r = { a: t },
                    s = {},
                    o = {},
                    a = { c: n },
                    ...
                    f = (h + c) / 2,
                    d = (f - u) / 8;
                return r.b = l + (t - l) / 4, s.b = u + d, r.c = s.a = (r.b + s.b) / 2, s.c = o.a = (u + f) / 2, o.b = f - d, a.b = c + (n - c) / 4, o.c = a.a = (o.b + a.b) / 2, [r, s, o, a]
            }, l = function(t, r, s, o, l) {
                var h, c, u, f, d, p, m, g, _, v, y, b, x, w = t.length - 1,
                    T = 0,
                    S = t[0].a;
                for (h = 0; w > h; h++) c = (d = t[T]).a, u = d.d, f = t[T + 1].d, l ? (y = e[h], x = ((b = i[h]) + y) * r * .25 / (o ? .5 : n[h] || .5), g = u - ((p = u - (u - c) * (o ? .5 * r : 0 !== y ? x / y : 0)) + (((m = u + (f - u) * (o ? .5 * r : 0 !== b ? x / b : 0)) - p) * (3 * y / (y + b) + .5) / 4 || 0))) : g = u - ((p = u - (u - c) * r * .5) + (m = u + (f - u) * r * .5)) / 2, p += g, m += g, d.c = _ = p, d.b = 0 !== h ? S : S = d.a + .6 * (d.c - d.a), d.da = u - c, d.ca = _ - c, d.ba = S - c, s ? (v = a(c, S, _, u), t.splice(T, 1, v[0], v[1], v[2], v[3]), T += 4) : T++, S = m;
                (d = t[T]).b = S, d.c = S + .4 * (d.d - S), d.da = d.d - d.a, d.ca = d.c - d.a, d.ba = S - d.a, s && (v = a(d.a, S, d.c, d.d), t.splice(T, 1, v[0], v[1], v[2], v[3]))
            }, h = function(t, n, r, s) {
                var a, l, h, c, u, f, d = [];
                if (s)
                ...
                for (l = 0; a > l; l++) h = t[l][n], c = t[l + 1][n], d[l] = new o(h, 0, 0, c), r && (u = t[l + 2][n], e[l] = (e[l] || 0) + (c - h) * (c - h), i[l] = (i[l] || 0) + (u - c) * (u - c));
                ...
                if (t.length > 1) {
                    for (y = t[t.length - 1], v = !0, f = x.length; --f > -1;)
                        if (d = x[f], Math.abs(w[d] - y[d]) > .05) { v = !1; break }
                    v && (t = t.concat(), u && t.unshift(u), t.push(t[1]), u = t[t.length - 3])
                }
                for (e.length = i.length = n.length = 0, f = x.length; --f > -1;) d = x[f], r[d] = -1 !== c.indexOf("," + d + ","), b[d] = h(t, d, r[d], u);
                for (f = e.length; --f > -1;) e[f] = Math.sqrt(e[f]), i[f] = Math.sqrt(i[f]);
                if (!a) {
                    for (f = x.length; --f > -1;)
                        if (r[d])
                            for (_ = (p = b[x[f]]).length - 1, m = 0; _ > m; m++) g = p[m + 1].da / i[m] + p[m].da / e[m] || 0, n[m] = (n[m] || 0) + g * g;
                    for (f = n.length; --f > -1;) n[f] = Math.sqrt(n[f])
                }
                for (f = x.length, m = o ? 4 : 1; --f > -1;) p = b[d = x[f]], l(p, s, o, a, r[d]), v && (p.splice(0, m), p.splice(p.length - m, m));
                return b
            }, u = function(t, e, i) {
                var n, r, s, a, l, h, c, u, f, d, p, m = {},
                ...
                for (h = v.length; --h > -1;) {
                    for (m[f = v[h]] = l = [], d = 0, u = t.length, c = 0; u > c; c++) n = null == i ? t[c][f] : "string" == typeof(p = t[c][f]) && "=" === p.charAt(1) ? i[f] + Number(p.charAt(0) + p.substr(2)) : Number(p), _ && c > 1 && u - 1 > c && (l[d++] = (n + l[d - 2]) / 2), l[d++] = n;
                    for (u = d - g + 1, d = 0, c = 0; u > c; c += g) n = l[c], r = l[c + 1], s = l[c + 2], a = 2 === g ? 0 : l[c + 3], l[d++] = p = 3 === g ? new o(n, r, s, a) : new o(n, (2 * r + n) / 3, (2 * r + s) / 3, s);
                    l.length = d
                }
                return m
            }, f = function(t, e, i) {
                for (var n, r, s, o, a, l, h, c, u, f, d, p = 1 / i, m = t.length; --m > -1;)
                    for (s = (f = t[m]).a, o = f.d - s, a = f.c - s, l = f.b - s, n = r = 0, c = 1; i >= c; c++) n = r - (r = ((h = p * c) * h * o + 3 * (u = 1 - h) * (h * a + u * l)) * h), e[d = m * i + c - 1] = (e[d] || 0) + n * n
            }, d = function(t, e) {
                var i, n, r, s, o = [],
                    a = [],
                    l = 0,
                ...
                for (r = o.length, n = 0; r > n; n++) l += Math.sqrt(o[n]), d[s = n % e] = l, s === c && (h += l, u[s = n / e >> 0] = d, a[s] = h, l = 0, d = []);
                ...
                set: function(e) {
                    var i, n, r, s, o, a, l, h, c, u, f = this._segCount,
                        d = this._func,
                        p = this._target,
                    ...
                    if (this._autoRotate) { var g, _, v, y, b, x, w, T = this._autoRotate; for (r = T.length; --r > -1;) s = T[r][2], x = T[r][3] || 0, w = !0 === T[r][4] ? 1 : t, o = this._beziers[T[r][0]], g = this._beziers[T[r][1]], o && g && (o = o[i], g = g[i], _ = o.a + (o.b - o.a) * a, _ += ((y = o.b + (o.c - o.b) * a) - _) * a, y += (o.c + (o.d - o.c) * a - y) * a, v = g.a + (g.b - g.a) * a, v += ((b = g.b + (g.c - g.b) * a) - v) * a, b += (g.c + (g.d - g.c) * a - b) * a, l = m ? Math.atan2(b - v, y - _) * w + x : this._initialRotations[r], this._mod[s] && (l = this._mod[s](l, p)), d[s] ? p[s](l) : p[s] = l) }
                }
            }), m = p.prototype, p.bezierThrough = c, p.cubicToQuadratic = a, p._autoCSS = !0, p.quadraticToCubic = function(t, e, i) { return new o(t, (2 * e + t) / 3, (2 * e + i) / 3, i) }, p._cssRegister = function() {
                var t = s.CSSPlugin;
                if (t) {
                    var e = t._internals,
                        i = e._parseToProxy,
                    ...
                    e._registerComplexSpecialProp("bezier", {
                        parser: function(t, e, s, o, a, l) {
                            ...
                            for (c in e) g[c] = e[c];
                            return g.values = m, (a = new r(t, "bezier", 0, 0, u.pt, 2)).data = u, a.plugin = l, a.setRatio = n, 0 === g.autoRotate && (g.autoRotate = !0), !g.autoRotate || g.autoRotate instanceof Array || (h = !0 === g.autoRotate ? 0 : Number(g.autoRotate), g.autoRotate = null != u.end.left ? [
            ...
            }, m._mod = function(t) { for (var e, i = this._overwriteProps, n = i.length; --n > -1;)(e = t[i[n]]) && "function" == typeof e && (this._mod[i[n]] = e) }, m._kill = function(t) {
                ...
                var i, n, r, s, o = function() { t.call(this, "css"), this._overwriteProps.length = 0, this.setRatio = o.prototype.setRatio },
                ...
                var c, u, f, d, p, m, g, _, v = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
                    ...
                    j = {},
                    N = { style: {} },
                    $ = _gsScope.document || { createElement: function() { return N } },
                    B = function(t, e) { return $.createElementNS ? $.createElementNS(e || "http://www.w3.org/1999/xhtml", t) : $.createElement(t) },
                    W = B("div"),
                    q = B("img"),
                    ...
                    G = "",
                    Q = "",
                    Z = function(t, e) { var i, n, r = (e = e || W).style; if (void 0 !== r[t]) return t; for (t = t.charAt(0).toUpperCase() + t.substr(1), i = ["O", "Moz", "ms", "Ms", "Webkit"], n = 5; --n > -1 && void 0 === r[i[n] + t];); return n >= 0 ? (G = "-" + (Q = 3 === n ? "ms" : i[n]).toLowerCase() + "-", Q + t) : null },
                    J = $.defaultView ? $.defaultView.getComputedStyle : function() {},
                    K = o.getStyle = function(t, e, i, n, r) { var s; return X || "opacity" !== e ? (!n && t.style[e] ? s = t.style[e] : (i = i || J(t)) ? s = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(k, "-$1").toLowerCase()) : t.currentStyle && (s = t.currentStyle[e]), null == r || s && "none" !== s && "auto" !== s && "auto auto" !== s ? s : r) : Y(t) },
                        ...
                        if (d && (n = -n), p && (n *= 100), "lineHeight" !== i || r)
                            if ("%" === r && -1 !== i.indexOf("border")) a = n / 100 * (c ? t.clientWidth : t.clientHeight);
                                ...
                                if (f.cssText = "border:0 solid red;position:" + K(t, "position") + ";line-height:0;", "%" !== r && u.appendChild && "v" !== r.charAt(0) && "rem" !== r) f[c ? "borderLeftWidth" : "borderTopWidth"] = n + r;
                                    ...
                                    if (u = t.parentNode || $.body, -1 !== K(u, "display").indexOf("flex") && (f.position = "absolute"), l = u._gsCache, h = e.ticker.frame, l && c && l.time === h) return l.width * n / 100;
                                    f[c ? "width" : "height"] = n + r
                                }
                                u.appendChild(W), a = parseFloat(W[c ? "offsetWidth" : "offsetHeight"]), u.removeChild(W), c && "%" === r && !1 !== o.cacheWidths && ((l = u._gsCache = u._gsCache || {}).time = h, l.width = a / n * 100), 0 !== a || s || (a = tt(t, i, n, r, !0))
                            }
                    ...
                    it = function(t, e) {
                        ...
                        if (e = e || J(t, null))
                            if (i = e.length)
                                for (; --i > -1;)(-1 === (r = e[i]).indexOf("-transform") || zt === r) && (s[r.replace(E, I)] = e.getPropertyValue(r));
                            else
                                for (i in e)(-1 === i.indexOf("Transform") || Et === i) && (s[i] = e[i]);
                        else if (e = t.currentStyle || t.style)
                            for (i in e) "string" == typeof i && void 0 === s[i] && (s[i.replace(E, I)] = e[i]);
                        return X || (s.opacity = Y(t)), n = Wt(t, e, !1), s.rotation = n.rotation, s.skewX = n.skewX, s.scaleX = n.scaleX, s.scaleY = n.scaleY, s.x = n.x, s.y = n.y, At && (s.z = n.z, s.rotationX = n.rotationX, s.rotationY = n.rotationY, s.scaleZ = n.scaleZ), s.filters && delete s.filters, s
                    },
                    nt = function(t, e, i, n, r) {
                        var s, o, a, l = {},
                            h = t.style;
                        for (o in i) "cssText" !== o && "length" !== o && isNaN(o) && (e[o] !== (s = i[o]) || r && r[o]) && -1 === o.indexOf("Origin") && ("number" == typeof s || "string" == typeof s) && (l[o] = "auto" !== s || "left" !== o && "top" !== o ? "" !== s && "auto" !== s && "none" !== s || "string" != typeof e[o] || "" === e[o].replace(x, "") ? s : 0 : et(t, o), void 0 !== h[o] && (a = new vt(h, o, h[o], a)));
                        if (n)
                    ...
                    lt = function(t, e) { return "function" == typeof t && (t = t(_, g)), "string" == typeof t && "=" === t.charAt(1) ? parseInt(t.charAt(0) + "1", 10) * parseFloat(t.substr(2)) : parseFloat(t) - parseFloat(e) || 0 },
                    ht = function(t, e) { return "function" == typeof t && (t = t(_, g)), null == t ? e : "string" == typeof t && "=" === t.charAt(1) ? parseInt(t.charAt(0) + "1", 10) * parseFloat(t.substr(2)) + e : parseFloat(t) || 0 },
                    ct = function(t, e, i, n) { var r, s, o, a, l, h = 1e-6; return "function" == typeof t && (t = t(_, g)), null == t ? a = e : "number" == typeof t ? a = t : (r = 360, s = t.split("_"), o = ((l = "=" === t.charAt(1)) ? parseInt(t.charAt(0) + "1", 10) * parseFloat(s[0].substr(2)) : parseFloat(s[0])) * (-1 === t.indexOf("rad") ? 1 : F) - (l ? 0 : e), s.length && (n && (n[i] = e + o), -1 !== t.indexOf("short") && ((o %= r) !== o % 180 && (o = 0 > o ? o + r : o - r)), -1 !== t.indexOf("_cw") && 0 > o ? o = (o + 3599999999640) % r - (o / r | 0) * r : -1 !== t.indexOf("ccw") && o > 0 && (o = (o - 3599999999640) % r - (o / r | 0) * r)), a = e + o), h > a && a > -h && (a = 0), a },
                        ...
                        if (t)
                            if ("number" == typeof t) i = [t >> 16, t >> 8 & 255, 255 & t];
                                ...
                                if ("," === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)), ut[t]) i = ut[t];
                                    ...
                                    if (i = f = t.match(v), e) { if (-1 !== t.indexOf("=")) return t.match(y) } else o = Number(i[0]) % 360 / 360, a = Number(i[1]) / 100, n = 2 * (l = Number(i[2]) / 100) - (r = .5 >= l ? l * (a + 1) : l + a - l * a), i.length > 3 && (i[3] = Number(i[3])), i[0] = ft(o + 1 / 3, n, r), i[1] = ft(o, n, r), i[2] = ft(o - 1 / 3, n, r);
                                else i = t.match(v) || ut.transparent;
                                i[0] = Number(i[0]), i[1] = Number(i[1]), i[2] = Number(i[2]), i.length > 3 && (i[3] = Number(i[3]))
                            }
                        else i = ut.black;
                        return e && !f && (n = i[0] / 255, r = i[1] / 255, s = i[2] / 255, l = ((h = Math.max(n, r, s)) + (c = Math.min(n, r, s))) / 2, h === c ? o = a = 0 : (u = h - c, a = l > .5 ? u / (2 - h - c) : u / (h + c), o = h === n ? (r - s) / u + (s > r ? 6 : 0) : h === r ? (s - n) / u + 2 : (n - r) / u + 4, o *= 60), i[0] = o + .5 | 0, i[1] = 100 * a + .5 | 0, i[2] = 100 * l + .5 | 0), i
                    },
                    pt = function(t, e) {
                ...
                var gt = function(t, e, i, n) {
                        ...
                        return c ? r = e ? function(t) {
                            ...
                            else if (n && M.test(t)) { for (p = t.replace(M, "|").split("|"), d = 0; d < p.length; d++) p[d] = r(p[d]); return p.join(",") }
                            ...
                            var e, s, f;
                            if ("number" == typeof t) t += u;
                            else if (n && M.test(t)) { for (s = t.replace(M, "|").split("|"), f = 0; f < s.length; f++) s[f] = r(s[f]); return s.join(",") }
                    ...
                    _t = function(t) {
                        return t = t.split(","),
                            function(e, i, n, r, s, o, a) { var l, h = (i + "").split(" "); for (a = {}, l = 0; 4 > l; l++) a[t[l]] = h[l] = h[l] || h[(l - 1) / 2 >> 0]; return r.parse(e, a, s, o) }
                    },
                    ...
                    yt = (U._parseToProxy = function(t, e, i, n, r, s) {
                        var o, a, l, h, c, u = n,
                            ...
                            p = i._transform,
                            m = j;
                        for (i._transform = null, j = e, n = c = i.parse(t, e, n, r), j = m, s && (i._transform = p, u && (u._prev = null, u._prev && (u._prev._next = null))); n && n !== u;) {
                            if (n.type <= 1 && (d[a = n.p] = n.s + n.c, f[a] = n.s, s || (h = new vt(n, "s", a, h, n.r), n.c = 0), 1 === n.type))
                                for (o = n.l; --o > 0;) l = "xn" + o, d[a = n.p + "_" + l] = n.data[l], f[a] = n[l], s || (h = new vt(n, l, a, h, n.rxp[l]));
                            n = n._next
                        }
                        return { proxy: f, end: d, firstMPT: h, pt: c }
                    }, U.CSSPropTween = function(t, e, n, r, o, a, l, h, c, u, f) { this.t = t, this.p = e, this.s = n, this.c = r, this.n = l || e, t instanceof yt || s.push(this.n), this.r = h, this.type = a || 0, c && (this.pr = c, i = !0), this.b = void 0 === u ? n : u, this.e = void 0 === f ? n + r : f, o && (this._next = o, o._prev = this) }),
                    bt = function(t, e, i, n, r, s) { var o = new yt(t, e, i, n - i, r, -1, s); return o.b = i, o.e = o.xs0 = n, o },
                    xt = o.parseComplex = function(t, e, i, n, r, s, a, l, h, u) {
                        ...
                        var f, d, p, m, b, x, w, T, S, C, P, k, E, z = i.split(", ").join(",").split(" "),
                            I = n.split(", ").join(",").split(" "),
                            A = z.length,
                            O = !1 !== c;
                        for ((-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && (-1 !== (n + i).indexOf("rgb") || -1 !== (n + i).indexOf("hsl") ? (z = z.join(" ").replace(M, ", ").split(" "), I = I.join(" ").replace(M, ", ").split(" ")) : (z = z.join(" ").split(",").join(", ").split(" "), I = I.join(" ").split(",").join(", ").split(" ")), A = z.length), A !== I.length && (A = (z = (s || "").split(" ")).length), a.plugin = h, a.setRatio = u, mt.lastIndex = 0, f = 0; A > f; f++)
                            if (m = z[f], b = I[f], (T = parseFloat(m)) || 0 === T) a.appendXtra("", T, lt(b, T), b.replace(y, ""), O && -1 !== b.indexOf("px"), !0);
                            else if (r && mt.test(m)) k = ")" + ((k = b.indexOf(")") + 1) ? b.substr(k) : ""), E = -1 !== b.indexOf("hsl") && X, C = b, m = dt(m, E), b = dt(b, E), (S = m.length + b.length > 6) && !X && 0 === b[3] ? (a["xs" + a.l] += a.l ? " transparent" : "transparent", a.e = a.e.split(I[f]).join("transparent")) : (X || (S = !1), E ? a.appendXtra(C.substr(0, C.indexOf("hsl")) + (S ? "hsla(" : "hsl("), m[0], lt(b[0], m[0]), ",", !1, !0).appendXtra("", m[1], lt(b[1], m[1]), "%,", !1).appendXtra("", m[2], lt(b[2], m[2]), S ? "%," : "%" + k, !1) : a.appendXtra(C.substr(0, C.indexOf("rgb")) + (S ? "rgba(" : "rgb("), m[0], b[0] - m[0], ",", !0, !0).appendXtra("", m[1], b[1] - m[1], ",", !0).appendXtra("", m[2], b[2] - m[2], S ? "," : k, !0), S && (m = m.length < 4 ? 1 : m[3], a.appendXtra("", m, (b.length < 4 ? 1 : b[3]) - m, k, !1))), mt.lastIndex = 0;
                        else if (x = m.match(v)) {
                            if (!(w = b.match(y)) || w.length !== x.length) return a;
                            for (p = 0, d = 0; d < x.length; d++) P = x[d], C = m.indexOf(P, p), a.appendXtra(m.substr(p, C - p), Number(P), lt(w[d], P), "", O && "px" === m.substr(C + P.length, 2), 0 === d), p = C + P.length;
                            a["xs" + a.l] += m.substr(p)
                ...
                h.xs0 = "", h._next = h._prev = h.xfirst = h.data = h.plugin = h.setRatio = h.rxp = null, h.appendXtra = function(t, e, i, n, r, s) {
                    var o = this,
                        a = o.l;
                    return o["xs" + a] += s && (a || o["xs" + a]) ? " " + t : t || "", i || 0 === a || o.plugin ? (o.l++, o.type = o.setRatio ? 2 : 1, o["xs" + o.l] = n || "", a > 0 ? (o.data["xn" + a] = e + i, o.rxp["xn" + a] = r, o["xn" + a] = e, o.plugin || (o.xfirst = new yt(o, "xn" + a, e, i, o.xfirst || o, 0, o.n, r, o.pr), o.xfirst.xs0 = 0), o) : (o.data = { s: e + i }, o.rxp = {}, o.s = e, o.c = i, o.r = r, o)) : (o["xs" + a] += e + (n || ""), o)
                };
                var Tt = function(t, e) { e = e || {}, this.p = e.prefix && Z(t) || t, l[t] = l[this.p] = this, this.format = e.formatter || gt(e.defaultValue, e.color, e.collapsible, e.multi), e.parser && (this.parse = e.parser), this.clrs = e.color, this.multi = e.multi, this.keyword = e.keyword, this.dflt = e.defaultValue, this.pr = e.priority || 0 },
                    ...
                    Ct = U._registerPluginProp = function(t) {
                        if (!l[t]) {
                            ...
                            St(t, { parser: function(t, i, n, r, s, o, h) { var c = a.com.greensock.plugins[e]; return c ? (c._cssRegister(), l[n].parse(t, i, n, r, s, o, h)) : (V("Error: " + e + " js file not loaded."), s) } })
                        }
                    };
                (h = Tt.prototype).parseComplex = function(t, e, i, n, r, s) {
                    ...
                    if (this.multi && (M.test(i) || M.test(e) ? (a = e.replace(M, "|").split("|"), l = i.replace(M, "|").split("|")) : f && (a = [e], l = [i])), l) {
                        for (h = l.length > a.length ? l.length : a.length, o = 0; h > o; o++) e = a[o] = a[o] || this.dflt, i = l[o] = l[o] || this.dflt, f && ((c = e.indexOf(f)) !== (u = i.indexOf(f)) && (-1 === u ? a[o] = a[o].split(f).join("") : -1 === c && (a[o] += " " + f)));
                        e = a.join(", "), i = l.join(", ")
                    }
                    return xt(t, this.p, e, i, this.clrs, this.dflt, n, this.pr, r, s)
                }, h.parse = function(t, e, i, n, s, o, a) { return this.parseComplex(t.style, this.format(K(t, this.p, r, !1, this.dflt)), this.format(e), s, o) }, o.registerSpecialProp = function(t, e, i) { St(t, { parser: function(t, n, r, s, o, a, l) { var h = new yt(t, r, 0, 0, o, 2, r, !1, i); return h.plugin = a, h.setRatio = e(t, n, s._tween, r), h }, priority: i }) }, o.useSVGTransformAttr = !0;
                var Pt, kt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                    ...
                    Ot = U.Transform = function() { this.perspective = parseFloat(o.defaultTransformPerspective) || 0, this.force3D = !(!1 === o.defaultForce3D || !At) && (o.defaultForce3D || "auto") },
                    ...
                    Lt = $.documentElement || {},
                    Rt = function() { var t, e, i, n = m || /Android/i.test(H) && !_gsScope.chrome; return $.createElementNS && !n && (t = Mt("svg", Lt), i = (e = Mt("rect", t, { width: 100, height: 50, x: 100 })).getBoundingClientRect().width, e.style[It] = "50% 50%", e.style[Et] = "scaleX(0.5)", n = i === e.getBoundingClientRect().width && !(d && At), Lt.removeChild(t)), n }(),
                    Ft = function(t, e, i, n, r, s) {
                        var a, l, h, c, u, f, d, p, m, g, _, v, y, b, x = t._gsTransform,
                            w = Bt(t, !0);
                        x && (y = x.xOrigin, b = x.yOrigin), (!n || (a = n.split(" ")).length < 2) && (0 === (d = t.getBBox()).x && 0 === d.y && d.width + d.height === 0 && (d = { x: parseFloat(t.hasAttribute("x") ? t.getAttribute("x") : t.hasAttribute("cx") ? t.getAttribute("cx") : 0) || 0, y: parseFloat(t.hasAttribute("y") ? t.getAttribute("y") : t.hasAttribute("cy") ? t.getAttribute("cy") : 0) || 0, width: 0, height: 0 }), a = [(-1 !== (e = at(e).split(" "))[0].indexOf("%") ? parseFloat(e[0]) / 100 * d.width : parseFloat(e[0])) + d.x, (-1 !== e[1].indexOf("%") ? parseFloat(e[1]) / 100 * d.height : parseFloat(e[1])) + d.y]), i.xOrigin = c = parseFloat(a[0]), i.yOrigin = u = parseFloat(a[1]), n && w !== $t && (f = w[0], d = w[1], p = w[2], m = w[3], g = w[4], _ = w[5], (v = f * m - d * p) && (l = c * (m / v) + u * (-p / v) + (p * _ - m * g) / v, h = c * (-d / v) + u * (f / v) - (f * _ - d * g) / v, c = i.xOrigin = a[0] = l, u = i.yOrigin = a[1] = h)), x && (s && (i.xOffset = x.xOffset, i.yOffset = x.yOffset, x = i), r || !1 !== r && !1 !== o.defaultSmoothOrigin ? (l = c - y, h = u - b, x.xOffset += l * w[0] + h * w[2] - l, x.yOffset += l * w[1] + h * w[3] - h) : x.xOffset = x.yOffset = 0), s || t.setAttribute("data-svg-origin", a.join(" "))
                    },
                    jt = function(t) {
                        ...
                        if (Lt.appendChild(i), i.appendChild(this), this.style.display = "block", t) try { e = this.getBBox(), this._originalGetBBox = this.getBBox, this.getBBox = jt } catch (t) {} else this._originalGetBBox && (e = this._originalGetBBox());
                        return r ? n.insertBefore(this, r) : n.appendChild(this), Lt.removeChild(i), this.style.cssText = s, e
                    },
                    Nt = function(t) { return !(!Dt || !t.getCTM || t.parentNode && !t.ownerSVGElement || ! function(t) { try { return t.getBBox() } catch (e) { return jt.call(t, !0) } }(t)) },
                    $t = [1, 0, 0, 1, 0, 0],
                    Bt = function(t, e) {
                        var i, n, r, s, o, a, l = t._gsTransform || new Ot,
                            h = 1e5,
                            c = t.style;
                        if (Et ? n = K(t, zt, null, !0) : t.currentStyle && (n = (n = t.currentStyle.filter.match(O)) && 4 === n.length ? [n[0].substr(4), Number(n[2].substr(4)), Number(n[1].substr(4)), n[3].substr(4), l.x || 0, l.y || 0].join(",") : ""), i = !n || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n, !Et || !(a = !J(t) || "none" === J(t).display) && t.parentNode || (a && (s = c.display, c.display = "block"), t.parentNode || (o = 1, Lt.appendChild(t)), i = !(n = K(t, zt, null, !0)) || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n, s ? c.display = s : a && Xt(c, "display"), o && Lt.removeChild(t)), (l.svg || t.getCTM && Nt(t)) && (i && -1 !== (c[Et] + "").indexOf("matrix") && (n = c[Et], i = 0), r = t.getAttribute("transform"), i && r && (n = "matrix(" + (r = t.transform.baseVal.consolidate().matrix).a + "," + r.b + "," + r.c + "," + r.d + "," + r.e + "," + r.f + ")", i = 0)), i) return $t;
                        for (r = (n || "").match(v) || [], wt = r.length; --wt > -1;) s = Number(r[wt]), r[wt] = (o = s - (s |= 0)) ? (o * h + (0 > o ? -.5 : .5) | 0) / h + s : s;
                        return e && r.length > 6 ? [r[0], r[1], r[4], r[5], r[12], r[13]] : r
                    },
                    Wt = U.getTransform = function(t, i, n, r) {
                        if (t._gsTransform && n && !r) return t._gsTransform;
                        var s, a, l, h, c, u, f = n && t._gsTransform || new Ot,
                            d = f.scaleX < 0,
                            p = 2e-5,
                            m = 1e5,
                            g = At && (parseFloat(K(t, It, i, !1, "0 0 0").split(" ")[2]) || f.zOrigin) || 0,
                            _ = parseFloat(o.defaultTransformPerspective) || 0;
                        if (f.svg = !(!t.getCTM || !Nt(t)), f.svg && (Ft(t, K(t, It, i, !1, "50% 50%") + "", f, t.getAttribute("data-svg-origin")), Pt = o.useSVGTransformAttr || Rt), (s = Bt(t)) !== $t) {
                            if (16 === s.length) {
                                var v, y, b, x, w, T = s[0],
                                    S = s[1],
                                    C = s[2],
                        ...
                        return n && (t._gsTransform = f, f.svg && (Pt && t.style[Et] ? e.delayedCall(.001, (function() { Xt(t.style, Et) })) : !Pt && t.getAttribute("transform") && e.delayedCall(.001, (function() { t.removeAttribute("transform") })))), f
                    },
                    qt = function(t) {
                        var e, i, n = this.data,
                            r = -n.rotation * R,
                        ...
                        if (f) {
                            ...
                            if (null != n.ox && (b += (d = (n.oxp ? g * n.ox * .01 : n.ox) - g / 2) - (d * a + (p = (n.oyp ? _ * n.oy * .01 : n.oy) - _ / 2) * l), x += p - (d * h + p * c)), v ? y += ", Dx=" + ((d = g / 2) - (d * a + (p = _ / 2) * l) + b) + ", Dy=" + (p - (d * h + p * c) + x) + ")" : y += ", sizingMethod='auto expand')", -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? u.filter = e.replace(D, y) : u.filter = y + " " + e, (0 === t || 1 === t) && 1 === a && 0 === l && 0 === h && 1 === c && (v && -1 === y.indexOf("Dx=0, Dy=0") || T.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf(e.indexOf("Alpha")) && u.removeAttribute("filter")), !v) { var S, C, P, k = 8 > m ? 1 : -1; for (d = n.ieOffsetX || 0, p = n.ieOffsetY || 0, n.ieOffsetX = Math.round((g - ((0 > a ? -a : a) * g + (0 > l ? -l : l) * _)) / 2 + b), n.ieOffsetY = Math.round((_ - ((0 > c ? -c : c) * _ + (0 > h ? -h : h) * g)) / 2 + x), wt = 0; 4 > wt; wt++) P = (i = -1 !== (S = f[C = st[wt]]).indexOf("px") ? parseFloat(S) : tt(this.t, C, parseFloat(S), S.replace(w, "")) || 0) !== n[C] ? 2 > wt ? -n.ieOffsetX : -n.ieOffsetY : 2 > wt ? d - n.ieOffsetX : p - n.ieOffsetY, u[C] = (n[C] = Math.round(i - P * (0 === wt || 2 === wt ? 1 : k))) + "px" }
                        }
                    },
                    Ut = U.set3DTransformRatio = U.setTransformRatio = function(t) {
                        var e, i, n, r, s, o, a, l, h, c, u, f, p, m, g, _, v, y, b, x, w, T, S, C = this.data,
                            P = this.t.style,
                            k = C.rotation,
                            E = C.rotationX,
                            z = C.rotationY,
                            ...
                            $ = C.skewY,
                            B = C.skewX;
                        if ($ && (B += $, k += $), !((1 !== t && 0 !== t || "auto" !== N || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && N || L || j || z || E || 1 !== O) || Pt && F || !At) k || B || F ? (k *= R, T = B * R, S = 1e5, i = Math.cos(k) * I, s = Math.sin(k) * I, n = Math.sin(k - T) * -A, o = Math.cos(k - T) * A, T && "simple" === C.skewType && (e = Math.tan(T - $ * R), n *= e = Math.sqrt(1 + e * e), o *= e, $ && (e = Math.tan($ * R), i *= e = Math.sqrt(1 + e * e), s *= e)), F && (D += C.xOrigin - (C.xOrigin * i + C.yOrigin * n) + C.xOffset, M += C.yOrigin - (C.xOrigin * s + C.yOrigin * o) + C.yOffset, Pt && (C.xPercent || C.yPercent) && (g = this.t.getBBox(), D += .01 * C.xPercent * g.width, M += .01 * C.yPercent * g.height), (g = 1e-6) > D && D > -g && (D = 0), g > M && M > -g && (M = 0)), b = (i * S | 0) / S + "," + (s * S | 0) / S + "," + (n * S | 0) / S + "," + (o * S | 0) / S + "," + D + "," + M + ")", F && Pt ? this.t.setAttribute("transform", "matrix(" + b) : P[Et] = (C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix(" : "matrix(") + b) : P[Et] = (C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix(" : "matrix(") + I + ",0,0," + A + "," + D + "," + M + ")";
                        else {
                            if (d && ((g = 1e-4) > I && I > -g && (I = O = 2e-5), g > A && A > -g && (A = O = 2e-5), !j || C.z || C.rotationX || C.rotationY || (j = 0)), k || B) k *= R, _ = i = Math.cos(k), v = s = Math.sin(k), B && (k -= B * R, _ = Math.cos(k), v = Math.sin(k), "simple" === C.skewType && (e = Math.tan((B - $) * R), _ *= e = Math.sqrt(1 + e * e), v *= e, C.skewY && (e = Math.tan($ * R), i *= e = Math.sqrt(1 + e * e), s *= e))), n = -v, o = _;
                            else {
                                if (!(z || E || 1 !== O || j || F)) return void(P[Et] = (C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) translate3d(" : "translate3d(") + D + "px," + M + "px," + L + "px)" + (1 !== I || 1 !== A ? " scale(" + I + "," + A + ")" : ""));
                                i = o = 1, n = s = 0
                            }
                            c = 1, r = a = l = h = u = f = 0, p = j ? -1 / j : 0, m = C.zOrigin, g = 1e-6, x = ",", w = "0", (k = z * R) && (_ = Math.cos(k), l = -(v = Math.sin(k)), u = p * -v, r = i * v, a = s * v, c = _, p *= _, i *= _, s *= _), (k = E * R) && (e = n * (_ = Math.cos(k)) + r * (v = Math.sin(k)), y = o * _ + a * v, h = c * v, f = p * v, r = n * -v + r * _, a = o * -v + a * _, c *= _, p *= _, n = e, o = y), 1 !== O && (r *= O, a *= O, c *= O, p *= O), 1 !== A && (n *= A, o *= A, h *= A, f *= A), 1 !== I && (i *= I, s *= I, l *= I, u *= I), (m || F) && (m && (D += r * -m, M += a * -m, L += c * -m + m), F && (D += C.xOrigin - (C.xOrigin * i + C.yOrigin * n) + C.xOffset, M += C.yOrigin - (C.xOrigin * s + C.yOrigin * o) + C.yOffset), g > D && D > -g && (D = w), g > M && M > -g && (M = w), g > L && L > -g && (L = 0)), b = C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix3d(" : "matrix3d(", b += (g > i && i > -g ? w : i) + x + (g > s && s > -g ? w : s) + x + (g > l && l > -g ? w : l), b += x + (g > u && u > -g ? w : u) + x + (g > n && n > -g ? w : n) + x + (g > o && o > -g ? w : o), E || z || 1 !== O ? (b += x + (g > h && h > -g ? w : h) + x + (g > f && f > -g ? w : f) + x + (g > r && r > -g ? w : r), b += x + (g > a && a > -g ? w : a) + x + (g > c && c > -g ? w : c) + x + (g > p && p > -g ? w : p) + x) : b += ",0,0,0,0,1,0,", b += D + x + M + x + L + x + (j ? 1 + -L / j : 1) + ")", P[Et] = b
                        }
                    };
                (h = Ot.prototype).x = h.y = h.z = h.skewX = h.skewY = h.rotation = h.rotationX = h.rotationY = h.zOrigin = h.xPercent = h.yPercent = h.xOffset = h.yOffset = 0, h.scaleX = h.scaleY = h.scaleZ = 1, St("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
                    parser: function(t, e, i, n, s, a, l) {
                        if (n._lastParsedTransform === l) return s;
                        n._lastParsedTransform = l;
                        var h, c = l.scale && "function" == typeof l.scale ? l.scale : 0;
                        "function" == typeof l[i] && (h = l[i], l[i] = e), c && (l.scale = c(_, t));
                        var u, f, d, p, m, v, y, b, x, w = t._gsTransform,
                            T = t.style,
                            S = 1e-6,
                            C = kt.length,
                            P = l,
                    ...
                    parser: function(t, e, i, s, o, a) {
                        e = this.format(e);
                        var l, h, c, u, f, d, p, m, g, _, v, y, b, x, w, T, S = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"],
                            C = t.style;
                        for (g = parseFloat(t.offsetWidth), _ = parseFloat(t.offsetHeight), l = e.split(" "), h = 0; h < S.length; h++) this.p.indexOf("border") && (S[h] = Z(S[h])), -1 !== (f = u = K(t, S[h], r, !1, "0px")).indexOf(" ") && (u = f.split(" "), f = u[0], u = u[1]), d = c = l[h], p = parseFloat(f), y = f.substr((p + "").length), (b = "=" === d.charAt(1)) ? (m = parseInt(d.charAt(0) + "1", 10), d = d.substr(2), m *= parseFloat(d), v = d.substr((m + "").length - (0 > m ? 1 : 0)) || "") : (m = parseFloat(d), v = d.substr((m + "").length)), "" === v && (v = n[i] || y), v !== y && (x = tt(t, "borderLeft", p, y), w = tt(t, "borderTop", p, y), "%" === v ? (f = x / g * 100 + "%", u = w / _ * 100 + "%") : "em" === v ? (f = x / (T = tt(t, "borderLeft", 1, "em")) + "em", u = w / T + "em") : (f = x + "px", u = w + "px"), b && (d = parseFloat(f) + m + v, c = parseFloat(u) + m + v)), o = xt(C, S[h], f + " " + u, d + " " + c, !1, "0px", o);
                        return o
                    },
                    prefix: !0,
                    formatter: gt("0px 0px 0px 0px", !1, !0)
                }), St("borderBottomLeftRadius,borderBottomRightRadius,borderTopLeftRadius,borderTopRightRadius", { defaultValue: "0px", parser: function(t, e, i, n, s, o) { return xt(t.style, i, this.format(K(t, i, r, !1, "0px 0px")), this.format(e), !1, "0px", s) }, prefix: !0, formatter: gt("0px 0px", !1, !0) }), St("backgroundPosition", {
                    defaultValue: "0 0",
                ...
                St("opacity,alpha,autoAlpha", {
                    ...
                    parser: function(t, e, i, n, s, o) {
                        var a = parseFloat(K(t, "opacity", r, !1, "1")),
                            l = t.style,
                            h = "autoAlpha" === i;
                        return "string" == typeof e && "=" === e.charAt(1) && (e = ("-" === e.charAt(0) ? -1 : 1) * parseFloat(e.substr(2)) + a), h && 1 === a && "hidden" === K(t, "visibility", r) && 0 !== e && (a = 0), X ? s = new yt(l, "opacity", a, e - a, s) : ((s = new yt(l, "opacity", 100 * a, 100 * (e - a), s)).xn1 = h ? 1 : 0, l.zoom = 1, s.type = 2, s.b = "alpha(opacity=" + s.s + ")", s.e = "alpha(opacity=" + (s.s + s.c) + ")", s.data = t, s.plugin = o, s.setRatio = Ht), h && ((s = new yt(l, "visibility", 0, 0, s, -1, null, !1, 0, 0 !== a ? "inherit" : "hidden", 0 === e ? "hidden" : "inherit")).xs0 = "inherit", n._overwriteProps.push(s.n), n._overwriteProps.push(i)), s
                    }
                });
                var Xt = function(t, e) { e && (t.removeProperty ? (("ms" === e.substr(0, 2) || "webkit" === e.substr(0, 6)) && (e = "-" + e), t.removeProperty(e.replace(k, "-$1").toLowerCase())) : t.removeAttribute(e)) },
                    Yt = function(t) {
                ...
                St("className", {
                    parser: function(t, e, n, s, o, a, l) {
                        var h, c, u, f, d, p = t.getAttribute("class") || "",
                            m = t.style.cssText;
                        if ((o = s._classNamePT = new yt(t, n, 0, 0, o, 2)).setRatio = Yt, o.pr = -11, i = !0, o.b = p, c = it(t, r), u = t._gsClassPT) {
                            for (f = {}, d = u.data; d;) f[d.p] = 1, d = d._next;
                            u.setRatio(1)
                        }
                        return t._gsClassPT = o, o.e = "=" !== e.charAt(1) ? e : p.replace(new RegExp("(?:\\s|^)" + e.substr(2) + "(?![\\w-])"), "") + ("+" === e.charAt(0) ? " " + e.substr(2) : ""), t.setAttribute("class", o.e), h = nt(t, c, it(t), l, f), t.setAttribute("class", p), o.data = h.firstMPT, t.style.cssText = m, o.xfirst = s.parse(t, h.difs, o, a)
                    }
                });
                var Vt = function(t) {
                    if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                        ...
                        if ("all" === this.e) o.cssText = "", r = !0;
                            ...
                            for (n = (e = this.e.split(" ").join("").split(",")).length; --n > -1;) i = e[n], l[i] && (l[i].parse === a ? r = !0 : i = "transformOrigin" === i ? It : l[i].p), Xt(o, i);
                ...
                for (St("clearProps", { parser: function(t, e, n, r, s) { return (s = new yt(t, n, 0, 0, s, 2)).setRatio = Vt, s.e = e, s.pr = -10, s.data = r._tween, i = !0, s } }), h = "bezier,throwProps,physicsProps,physics2D".split(","), wt = h.length; wt--;) Ct(h[wt]);
                (h = o.prototype)._firstPT = h._lastParsedTransform = h._transform = null, h._onInitTween = function(t, e, a, h) {
                    ...
                    var d, m, v, y, b, x, w, T, C, P = t.style;
                    if (u && "" === P.zIndex && (("auto" === (d = K(t, "zIndex", r)) || "" === d) && this._addLazySet(P, "zIndex", 0)), "string" == typeof e && (y = P.cssText, d = it(t, r), P.cssText = y + ";" + e, d = nt(t, d, it(t)).difs, !X && S.test(e) && (d.opacity = parseFloat(RegExp.$1)), e = d, P.cssText = y), e.className ? this._firstPT = m = l.className.parse(t, e.className, "className", this, null, null, e) : this._firstPT = m = this.parse(t, e, null), this._transformType) {
                        for (C = 3 === this._transformType, Et ? f && (u = !0, "" === P.zIndex && (("auto" === (w = K(t, "zIndex", r)) || "" === w) && this._addLazySet(P, "zIndex", 0)), p && this._addLazySet(P, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (C ? "visible" : "hidden"))) : P.zoom = 1, v = m; v && v._next;) v = v._next;
                        T = new yt(t, "transform", 0, 0, null, 2), this._linkCSSP(T, null, v), T.setRatio = Et ? Ut : qt, T.data = this._transform || Wt(t, r, !0), T.tween = a, T.pr = -1, s.pop()
                    }
                    if (i) {
                        for (; m;) {
                    ...
                    var o, a, h, u, f, d, p, m, v, y, b = t.style;
                    for (o in e) {
                        if ("function" == typeof(d = e[o]) && (d = d(_, g)), a = l[o]) i = a.parse(t, d, o, this, i, s, e);
                        else {
                            if ("--" === o.substr(0, 2)) { this._tween._propLookup[o] = this._addTween.call(this._tween, t.style, "setProperty", J(t).getPropertyValue(o) + "", d + "", o, !1, o); continue }
                            f = K(t, o, r) + "", v = "string" == typeof d, "color" === o || "fill" === o || "stroke" === o || -1 !== o.indexOf("Color") || v && P.test(d) ? (v || (d = ((d = dt(d)).length > 3 ? "rgba(" : "rgb(") + d.join(",") + ")"), i = xt(b, o, f, d, !0, "transparent", i, 0, s)) : v && L.test(d) ? i = xt(b, o, f, d, !0, null, i, 0, s) : (p = (h = parseFloat(f)) || 0 === h ? f.substr((h + "").length) : "", ("" === f || "auto" === f) && ("width" === o || "height" === o ? (h = ot(t, o, r), p = "px") : "left" === o || "top" === o ? (h = et(t, o, r), p = "px") : (h = "opacity" !== o ? 0 : 1, p = "")), (y = v && "=" === d.charAt(1)) ? (u = parseInt(d.charAt(0) + "1", 10), d = d.substr(2), u *= parseFloat(d), m = d.replace(w, "")) : (u = parseFloat(d), m = v ? d.replace(w, "") : ""), "" === m && (m = o in n ? n[o] : p), d = u || 0 === u ? (y ? u + h : u) + m : e[o], p !== m && ("" !== m || "lineHeight" === o) && (u || 0 === u) && h && (h = tt(t, o, h, p), "%" === m ? (h /= tt(t, o, 100, "%") / 100, !0 !== e.strictUnits && (f = h + "%")) : "em" === m || "rem" === m || "vw" === m || "vh" === m ? h /= tt(t, o, 1, m) : "px" !== m && (u = tt(t, o, u, m), m = "px"), y && (u || 0 === u) && (d = u + h + m)), y && (u += h), !h && 0 !== h || !u && 0 !== u ? void 0 !== b[o] && (d || d + "" != "NaN" && null != d) ? (i = new yt(b, o, u || h || 0, 0, i, -1, o, !1, 0, f, d)).xs0 = "none" !== d || "display" !== o && -1 === o.indexOf("Style") ? d : f : V("invalid " + o + " tween value: " + e[o]) : (i = new yt(b, o, h, u - h, i, 0, o, !1 !== c && ("px" === m || "zIndex" === o), 0, f, d)).xs0 = m)
                        }
                ...
                }, h._enableTransforms = function(t) { this._transform = this._transform || Wt(this._target, r, !0), this._transformType = this._transform.svg && Pt || !t && 3 !== this._transformType ? 2 : 3 };
            ...
            function() {
                var t = _gsScope._gsDefine.plugin({ propName: "roundProps", version: "1.6.0", priority: -1, API: 2, init: function(t, e, i) { return this._tween = i, !0 } }),
            ...
            }(), _gsScope._gsDefine.plugin({ propName: "attr", API: 2, version: "0.6.1", init: function(t, e, i, n) { var r, s; if ("function" != typeof t.setAttribute) return !1; for (r in e) "function" == typeof(s = e[r]) && (s = s(n, t)), this._addTween(t, "setAttribute", t.getAttribute(r) + "", s + "", r, !1, r), this._overwriteProps.push(r); return !0 } }), _gsScope._gsDefine.plugin({
                ...
                init: function(t, e, i, n) {
                    ...
                    var r, s, o, a, l, h, c = !0 === e.useRadians ? 2 * Math.PI : 360,
                        u = 1e-6;
                    for (r in e) "useRadians" !== r && ("function" == typeof(a = e[r]) && (a = a(n, t)), s = (h = (a + "").split("_"))[0], o = parseFloat("function" != typeof t[r] ? t[r] : t[r.indexOf("set") || "function" != typeof t["get" + r.substr(3)] ? r : "get" + r.substr(3)]()), l = (a = this.finals[r] = "string" == typeof s && "=" === s.charAt(1) ? o + parseInt(s.charAt(0) + "1", 10) * Number(s.substr(2)) : Number(s) || 0) - o, h.length && (-1 !== (s = h.join("_")).indexOf("short") && ((l %= c) !== l % (c / 2) && (l = 0 > l ? l + c : l - c)), -1 !== s.indexOf("_cw") && 0 > l ? l = (l + 9999999999 * c) % c - (l / c | 0) * c : -1 !== s.indexOf("ccw") && l > 0 && (l = (l - 9999999999 * c) % c - (l / c | 0) * c)), (l > u || -u > l) && (this._addTween(t, r, o, o + l, r), this._overwriteProps.push(r)));
                    return !0
                },
                set: function(t) {
                    var e;
                ...
                var e, i, n, r, s = _gsScope.GreenSockGlobals || _gsScope,
                    ...
                    f = function(t, e, i, n, r) { var s = h("easing." + t, { easeOut: new e, easeIn: new i, easeInOut: new n }, !0); return u(s, t), s },
                ...
                }, _.config = function(t) { return new n(t) }, n.ease = new n, f("Bounce", c("BounceOut", (function(t) { return 1 / 2.75 > t ? 7.5625 * t * t : 2 / 2.75 > t ? 7.5625 * (t -= 1.5 / 2.75) * t + .75 : 2.5 / 2.75 > t ? 7.5625 * (t -= 2.25 / 2.75) * t + .9375 : 7.5625 * (t -= 2.625 / 2.75) * t + .984375 })), c("BounceIn", (function(t) { return (t = 1 - t) < 1 / 2.75 ? 1 - 7.5625 * t * t : 2 / 2.75 > t ? 1 - (7.5625 * (t -= 1.5 / 2.75) * t + .75) : 2.5 / 2.75 > t ? 1 - (7.5625 * (t -= 2.25 / 2.75) * t + .9375) : 1 - (7.5625 * (t -= 2.625 / 2.75) * t + .984375) })), c("BounceInOut", (function(t) { var e = .5 > t; return t = 1 / 2.75 > (t = e ? 1 - 2 * t : 2 * t - 1) ? 7.5625 * t * t : 2 / 2.75 > t ? 7.5625 * (t -= 1.5 / 2.75) * t + .75 : 2.5 / 2.75 > t ? 7.5625 * (t -= 2.25 / 2.75) * t + .9375 : 7.5625 * (t -= 2.625 / 2.75) * t + .984375, e ? .5 * (1 - t) : .5 * t + .5 }))), f("Circ", c("CircOut", (function(t) { return Math.sqrt(1 - (t -= 1) * t) })), c("CircIn", (function(t) { return -(Math.sqrt(1 - t * t) - 1) })), c("CircInOut", (function(t) { return (t *= 2) < 1 ? -.5 * (Math.sqrt(1 - t * t) - 1) : .5 * (Math.sqrt(1 - (t -= 2) * t) + 1) }))), f("Elastic", (r = function(e, i, n) {
                    var r = h("easing." + e, (function(t, e) { this._p1 = t >= 1 ? t : 1, this._p2 = (e || n) / (1 > t ? t : 1), this._p3 = this._p2 / a * (Math.asin(1 / this._p1) || 0), this._p2 = a / this._p2 }), !0),
                        s = r.prototype = new t;
        ...
        if (!r.TweenLite) {
            var s, o, a, l, h, c = function(t) {
                ...
                _ = function(n, s, o, a) {
                    ...
                    this.check = function(h) {
                        for (var u, f, d, p, m = s.length, v = m; --m > -1;)(u = g[s[m]] || new _(s[m], [])).gsClass ? (l[m] = u.gsClass, v--) : h && u.sc.push(this);
                        if (0 === v && o) {
                            ...
                            else "function" == typeof define && define.amd && define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/" : "") + n.split(".").pop(), [], (function() { return p }));
                            for (m = 0; m < this.sc.length; m++) this.sc[m].check()
                        }
                    }, this.check(!0)
                },
                v = t._gsDefine = function(t, e, i, n) { return new _(t, e, i, n) },
            ...
            var b = [0, 0, 1, 1],
                ...
                T = x.register = function(t, e, i, n) {
                    for (var r, s, o, a, l = e.split(","), h = l.length, c = (i || "easeIn,easeOut,easeInOut").split(","); --h > -1;)
                        for (s = l[h], r = n ? y("easing." + s, null, !0) : u.easing[s] || {}, o = c.length; --o > -1;) a = c[o], w[s + "." + a] = w[a + s] = r[a] = t.getRatio ? t : t[a] || new t
                };
            ...
            y("Ticker", (function(t, e) {
                var i, r, s, o, a, c = this,
                    ...
                    _ = function(t) {
                        var e, n, l = k() - E;
                        l > m && (u += l - g), E += l, c.time = (E - u) / 1e3, e = c.time - a, (!i || e > 0 || !0 === t) && (c.frame++, a += e + (e >= o ? .004 : o - e), n = !0), !0 !== t && (s = r(_)), n && c.dispatchEvent("tick")
                    };
            ...
            l = z.ticker = new u.Ticker, (a = z.prototype)._dirty = a._gc = a._initted = a._paused = !1, a._totalTime = a._time = 0, a._rawPrevTime = -1, a._next = a._last = a._onUpdate = a._timeline = a.timeline = null, a._paused = !1;
            var I = function() {
            ...
            V._startTime = l.time, Y._startTime = l.frame, V._active = Y._active = !0, setTimeout(Q, 1), z._updateRoot = O.render = function() {
                var t, e, i;
                if (M.length && Q(), V.render((l.time - V._startTime) * V._timeScale, !1, !1), Y.render((l.frame - Y._startTime) * Y._timeScale, !1, !1), M.length && Q(), l.frame >= G) {
                    for (i in G = l.frame + (parseInt(O.autoSleep, 10) || 120), q) {
                        for (t = (e = q[i].tweens).length; --t > -1;) e[t]._gc && e.splice(t, 1);
                        0 === e.length && delete q[i]
                    }
                    if ((!(i = V._first) || i._paused) && O.autoSleep && !Y._first && 1 === l._listeners.tick.length) {
            ...
            var Z = function(t, e, i) {
                    ...
                    if (q[s || (t._gsTweenID = s = "t" + U++)] || (q[s] = { target: t, tweens: [] }), e && ((n = q[s].tweens)[r = n.length] = e, i))
                        for (; --r > -1;) n[r] === e && n.splice(r, 1);
                    return q[s].tweens
                },
                J = function(t, e, i, n) { var r, s, o = t.vars.onOverwrite; return o && (r = o(t, e, i, n)), (o = O.onOverwrite) && (s = o(t, e, i, n)), !1 !== r && !1 !== s },
                K = function(t, e, i, n, r) {
                    ...
                    var h, c = e._startTime + f,
                        ...
                        d = 0,
                        p = 0 === e._duration;
                    for (s = r.length; --s > -1;)(a = r[s]) === e || a._gc || a._paused || (a._timeline !== e._timeline ? (h = h || tt(e, 0, p), 0 === tt(a, h, p) && (u[d++] = a)) : a._startTime <= c && a._startTime + a.totalDuration() / a._timeScale > c && ((p || !a._initted) && c - a._startTime <= 2e-10 || (u[d++] = a)));
                    for (s = d; --s > -1;)
            ...
            a._init = function() {
                ...
                if (o.startAt) {
                    ...
                    if (r.data = "isStart", r.overwrite = !1, r.immediateRender = !0, r.lazy = h && !1 !== o.lazy, r.startAt = r.delay = null, r.onUpdate = o.onUpdate, r.onUpdateParams = o.onUpdateParams, r.onUpdateScope = o.onUpdateScope || o.callbackScope || this, this._startAt = O.to(this.target, 0, r), h)
                        if (this._time > 0) this._startAt = null;
                        else if (0 !== l) return
                } else if (o.runBackwards && 0 !== l)
                    if (this._startAt) this._startAt.render(-1, !0), this._startAt.kill(), this._startAt = null;
                    else { for (n in 0 !== this._time && (h = !1), i = {}, o) H[n] && "autoCSS" !== n || (i[n] = o[n]); if (i.overwrite = 0, i.data = "isFromStart", i.lazy = h && !1 !== o.lazy, i.immediateRender = h, this._startAt = O.to(this.target, 0, i), h) { if (0 === this._time) return } else this._startAt._init(), this._startAt._enabled(!1), this.vars.immediateRender && (this._startAt = null) }
                if (this._ease = c = c ? c instanceof x ? c : "function" == typeof c ? new x(c, o.easeParams) : w[c] || O.defaultEase : O.defaultEase, o.easeParams instanceof Array && c.config && (this._ease = c.config.apply(c, o.easeParams)), this._easeType = this._ease._type, this._easePower = this._ease._power, this._firstPT = null, this._targets)
                ...
                var o, a, l, h, c, u;
                if (null == e) return !1;
                for (o in L[e._gsTweenID] && Q(), this.vars.css || e.style && e !== t && e.nodeType && W.css && !1 !== this.vars.autoCSS && function(t, e) {
                        var i, n = {};
                    ...
                    if (u = this.vars[o], H[o]) u && (u instanceof Array || u.push && m(u)) && -1 !== u.join("").indexOf("{self}") && (this.vars[o] = u = this._swapSelfInParams(u, this));
                ...
                } else i[o] = $.call(this, e, o, "get", u, o, 0, null, this.vars.stringFilter, s);
                return r && this._kill(r, e) ? this._initProps(e, i, n, r, s) : this._overwrite > 1 && this._firstPT && n.length > 1 && K(e, this, i, this._overwrite, n) ? (this._kill(i, e), this._initProps(e, i, n, r, s)) : (this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration) && (L[e._gsTweenID] = !0), l)
            }, a.render = function(t, e, i) {
                var n, r, s, o, a = this._time,
                    l = this._duration,
                    h = this._rawPrevTime;
                if (t >= l - 1e-7 && t >= 0) this._totalTime = this._time = l, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (n = !0, r = "onComplete", i = i || this._timeline.autoRemoveChildren), 0 === l && (this._initted || !this.vars.lazy || i) && (this._startTime === this._timeline._duration && (t = 0), (0 > h || 0 >= t && t >= -1e-7 || h === f && "isPause" !== this.data) && h !== t && (i = !0, h > f && (r = "onReverseComplete")), this._rawPrevTime = o = !e || t || h === t ? t : f);
                else if (1e-7 > t) this._totalTime = this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== a || 0 === l && h > 0) && (r = "onReverseComplete", n = this._reversed), 0 > t && (this._active = !1, 0 === l && (this._initted || !this.vars.lazy || i) && (h >= 0 && (h !== f || "isPause" !== this.data) && (i = !0), this._rawPrevTime = o = !e || t || h === t ? t : f)), (!this._initted || this._startAt && this._startAt.progress()) && (i = !0);
                ...
                if ((m(e) || D(e)) && "number" != typeof e[0])
                    ...
                    if (a) { if (h = t || a, c = t !== r && "all" !== r && t !== a && ("object" != typeof t || !t._tempKill), i && (O.onOverwrite || this.vars.onOverwrite)) { for (s in h) a[s] && (u || (u = []), u.push(s)); if ((u || !t) && !J(this, i, e, u)) return !1 } for (s in h)(o = a[s]) && (f && (o.f ? o.t[o.p](o.s) : o.t[o.p] = o.s, l = !0), o.pg && o.t._kill(h) && (l = !0), o.pg && 0 !== o.t._overwriteProps.length || (o._prev ? o._prev._next = o._next : o === this._firstPT && (this._firstPT = o._next), o._next && (o._next._prev = o._prev), o._next = o._prev = null), delete a[s]), c && (r[s] = 1);!this._firstPT && this._initted && this._enabled(!1, !1) }
                }
                return l
            }, a.invalidate = function() { return this._notifyPluginsOfEnabled && O._onPluginEvent("_onDisable", this), this._firstPT = this._overwrittenProps = this._startAt = this._onUpdate = null, this._notifyPluginsOfEnabled = this._active = this._lazy = !1, this._propLookup = this._targets ? {} : [], z.prototype.invalidate.call(this), this.vars.immediateRender && (this._time = -f, this.render(Math.min(0, -this._delay))), this }, a._enabled = function(t, e) {
                ...
                return z.prototype._enabled.call(this, t, e), !(!this._notifyPluginsOfEnabled || !this._firstPT) && O._onPluginEvent(t ? "_onEnable" : "_onDisable", this)
            }, O.to = function(t, e, i) { return new O(t, e, i) }, O.from = function(t, e, i) { return i.runBackwards = !0, i.immediateRender = 0 != i.immediateRender, new O(t, e, i) }, O.fromTo = function(t, e, i, n) { return n.startAt = i, n.immediateRender = 0 != n.immediateRender && 0 != i.immediateRender, new O(t, e, n) }, O.delayedCall = function(t, e, i, n, r) { return new O(e, 0, { delay: t, onComplete: e, onCompleteParams: i, callbackScope: n, onReverseComplete: e, onReverseCompleteParams: i, immediateRender: !1, lazy: !1, useFrames: r, overwrite: 0 }) }, O.set = function(t, e) { return new O(t, 0, e) }, O.getTweensOf = function(t, e) {
                if (null == t) return [];
                var i, n, r, s;
                if (t = "string" != typeof t ? t : O.selector(t) || t, (m(t) || D(t)) && "number" != typeof t[0]) {
                ...
                return n || []
            }, O.killTweensOf = O.killDelayedCallsTo = function(t, e, i) { "object" == typeof e && (i = e, e = !1); for (var n = O.getTweensOf(t, e), r = n.length; --r > -1;) n[r]._kill(i, t) };
            ...
            if (a = et.prototype, et.version = "1.19.0", et.API = 2, a._firstPT = null, a._addTween = $, a.setRatio = j, a._kill = function(t) {
                    ...
                    return !1
                }, a._mod = a._roundProps = function(t) { for (var e, i = this._firstPT; i;)(e = t[this._propName] || null != i.n && t[i.n.split(this._propName + "_").join("")]) && "function" == typeof e && (2 === i.f ? i.t._applyPT.m = e : i.m = e), i = i._next }, O._onPluginEvent = function(t, e) {
                    ...
                    return i
                }, et.activate = function(t) { for (var e = t.length; --e > -1;) t[e].API === et.API && (W[(new t[e])._propName] = t[e]); return !0 }, v.plugin = function(t) {
                    if (!(t && t.propName && t.init && t.API)) throw "illegal plugin definition.";
                    var e, i = t.propName,
                        n = t.priority || 0,
                        r = t.overwriteProps,
                        s = { init: "_onInitTween", set: "setRatio", kill: "_kill", round: "_mod", mod: "_mod", initAll: "_onInitAllProps" },
                        o = y("plugins." + i.charAt(0).toUpperCase() + i.substr(1) + "Plugin", (function() { et.call(this, i, n), this._overwriteProps = r || [] }), !0 === t.global),
                ...
                }, s = t._gsQueue) { for (o = 0; o < s.length; o++) s[o](); for (a in g) g[a].func || t.console.log("GSAP encountered missing dependency: " + a) }
            h = !1
        }
        ...
        var t = Math.PI / 180,
            ...
            h = function(i, n, r, s, o, a, l, h, c) {
                if (i !== h || n !== c) {
                    ...
                    var u = o % 360 * t,
                        ...
                        x = _ * _,
                        w = b / v + x / y;
                    w > 1 && (v = (r = Math.sqrt(w) * r) * r, y = (s = Math.sqrt(w) * s) * s);
                    var T = a === l ? -1 : 1,
                        S = (v * y - v * x - y * b) / (v * x + y * b);
                    0 > S && (S = 0);
                    var C = T * Math.sqrt(S),
                        P = C * (r * _ / s),
                        k = C * (-s * g / r),
                        ...
                        M = Math.sqrt(I * I + A * A),
                        L = I,
                        R = (T = 0 > A ? -1 : 1) * Math.acos(L / M) * e;
                    M = Math.sqrt((I * I + A * A) * (O * O + D * D)), L = I * O + A * D;
                    var F = (T = 0 > I * D - A * O ? -1 : 1) * Math.acos(L / M) * e;
                    !l && F > 0 ? F -= 360 : l && 0 > F && (F += 360);
                    var j, N, $, B = function(e, i) {
                            var n, r, s, o, a, l, h = Math.ceil(Math.abs(i) / 90),
                                c = 0,
                                u = [];
                            for (e *= t, n = (i *= t) / h, r = 4 / 3 * Math.sin(n / 2) / (1 + Math.cos(n / 2)), l = 0; h > l; l++) s = e + l * n, o = Math.cos(s), a = Math.sin(s), u[c++] = o - r * a, u[c++] = a + r * o, s += n, o = Math.cos(s), a = Math.sin(s), u[c++] = o + r * a, u[c++] = a - r * o, u[c++] = o, u[c++] = a;
                            return u
                        }(R %= 360, F %= 360),
                        W = f * r,
                        q = d * r,
                        ...
                        H = f * s,
                        X = B.length - 2;
                    for (j = 0; X > j; j += 2) N = B[j], $ = B[j + 1], B[j] = N * W + $ * U + E, B[j + 1] = N * q + $ * H + z;
                    return B[B.length - 2] = h, B[B.length - 1] = c, B
                }
            },
            c = function(t) {
                var e, n, r, s, a, c, u, f, d, p, m, g, _, v = (t + "").replace(o, (function(t) { var e = +t; return 1e-4 > e && e > -1e-4 ? 0 : e })).match(i) || [],
                    y = [],
                    b = 0,
                    x = 0,
                    w = v.length,
                ...
                for (e = 0; w > e; e++)
                    if (_ = a, isNaN(v[e]) ? c = (a = v[e].toUpperCase()) !== v[e] : e--, r = +v[e + 1], s = +v[e + 2], c && (r += b, s += x), 0 === e && (f = r, d = s), "M" === a) u && u.length < 8 && (y.length -= 1, T = 0), b = f = r, x = d = s, u = [r, s], S += T, T = 2, y.push(u), e += 2, a = "L";
                    else if ("C" === a) u || (u = [0, 0]), u[T++] = r, u[T++] = s, c || (b = x = 0), u[T++] = b + 1 * v[e + 3], u[T++] = x + 1 * v[e + 4], u[T++] = b += 1 * v[e + 5], u[T++] = x += 1 * v[e + 6], e += 6;
                else if ("S" === a) "C" === _ || "S" === _ ? (p = b - u[T - 4], m = x - u[T - 3], u[T++] = b + p, u[T++] = x + m) : (u[T++] = b, u[T++] = x), u[T++] = r, u[T++] = s, c || (b = x = 0), u[T++] = b += 1 * v[e + 3], u[T++] = x += 1 * v[e + 4], e += 4;
                else if ("Q" === a) p = r - b, m = s - x, u[T++] = b + 2 * p / 3, u[T++] = x + 2 * m / 3, c || (b = x = 0), p = r - (b += 1 * v[e + 3]), m = s - (x += 1 * v[e + 4]), u[T++] = b + 2 * p / 3, u[T++] = x + 2 * m / 3, u[T++] = b, u[T++] = x, e += 4;
                else if ("T" === a) p = b - u[T - 4], m = x - u[T - 3], u[T++] = b + p, u[T++] = x + m, p = b + 1.5 * p - r, m = x + 1.5 * m - s, u[T++] = r + 2 * p / 3, u[T++] = s + 2 * m / 3, u[T++] = b = r, u[T++] = x = s, e += 2;
                else if ("H" === a) s = x, u[T++] = b + (r - b) / 3, u[T++] = x + (s - x) / 3, u[T++] = b + 2 * (r - b) / 3, u[T++] = x + 2 * (s - x) / 3, u[T++] = b = r, u[T++] = s, e += 1;
                else if ("V" === a) s = r, r = b, c && (s += x - b), u[T++] = r, u[T++] = x + (s - x) / 3, u[T++] = r, u[T++] = x + 2 * (s - x) / 3, u[T++] = r, u[T++] = x = s, e += 1;
                else if ("L" === a || "Z" === a) "Z" === a && (r = f, s = d, u.closed = !0), ("L" === a || Math.abs(b - r) > .5 || Math.abs(x - s) > .5) && (u[T++] = b + (r - b) / 3, u[T++] = x + (s - x) / 3, u[T++] = b + 2 * (r - b) / 3, u[T++] = x + 2 * (s - x) / 3, u[T++] = r, u[T++] = s, "L" === a && (e += 2)), b = r, x = s;
                else if ("A" === a) {
                    if (g = h(b, x, 1 * v[e + 1], 1 * v[e + 2], 1 * v[e + 3], 1 * v[e + 4], 1 * v[e + 5], (c ? b : 0) + 1 * v[e + 6], (c ? x : 0) + 1 * v[e + 7]))
                        for (n = 0; n < g.length; n++) u[T++] = g[n];
                    b = u[T - 2], x = u[T - 1], e += 7
                } else l("Error: malformed path data: " + t);
                return y.totalPoints = S + T, y
            },
            u = function(t, e) {
                var i, n, r, s, o, a, l, h, c, u, f, d, p, m, g = 0,
                    _ = t.length,
                    v = e / ((_ - 2) / 6);
                for (p = 2; _ > p; p += 6)
                    for (g += v; g > .999999;) i = t[p - 2], n = t[p - 1], r = t[p], s = t[p + 1], o = t[p + 2], a = t[p + 3], l = t[p + 4], h = t[p + 5], c = i + (r - i) * (m = 1 / (Math.floor(g) + 1)), c += ((f = r + (o - r) * m) - c) * m, f += (o + (l - o) * m - f) * m, u = n + (s - n) * m, u += ((d = s + (a - s) * m) - u) * m, d += (a + (h - a) * m - d) * m, t.splice(p, 4, i + (r - i) * m, n + (s - n) * m, c, u, c + (f - c) * m, u + (d - u) * m, f, d, o + (l - o) * m, a + (h - a) * m), p += 6, _ += 6, g--;
                return t
            },
            f = function(t) {
                var e, i, n, r, s = "",
                    ...
                    a = 100;
                for (i = 0; o > i; i++) {
                    for (s += "M" + (r = t[i])[0] + "," + r[1] + " C", e = r.length, n = 2; e > n; n++) s += (r[n++] * a | 0) / a + "," + (r[n++] * a | 0) / a + " " + (r[n++] * a | 0) / a + "," + (r[n++] * a | 0) / a + " " + (r[n++] * a | 0) / a + "," + (r[n] * a | 0) / a + " ";
                    r.closed && (s += "z")
                }
                return s
            },
            ...
            m = function(t) {
                var e, i, n, r = t.length,
                    ...
                    a = t[1],
                    l = a;
                for (n = 6; r > n; n += 6)(e = t[n]) > s ? s = e : o > e && (o = e), (i = t[n + 1]) > a ? a = i : l > i && (l = i);
                return t.centerX = (s + o) / 2, t.centerY = (a + l) / 2, t.size = (s - o) * (a - l)
            },
            g = function(t) {
                for (var e, i, n, r, s, o = t.length, a = t[0][0], l = a, h = t[0][1], c = h; --o > -1;)
                    for (e = (s = t[o]).length, r = 6; e > r; r += 6)(i = s[r]) > a ? a = i : l > i && (l = i), (n = s[r + 1]) > h ? h = n : c > n && (c = n);
                return t.centerX = (a + l) / 2, t.centerY = (h + c) / 2, t.size = (a - l) * (h - c)
            },
            _ = function(t, e) { return e.length - t.length },
            v = function(t, e) {
                var i = t.size || m(t),
                    n = e.size || m(e);
            ...
            y = function(t, e) {
                var i, n, r = t.slice(0),
                    s = t.length,
                    o = s - 2;
                for (e |= 0, i = 0; s > i; i++) n = (i + e) % o, t[i++] = r[n], t[i] = r[n + 1]
            },
            b = function(t, e, i, n, r) {
                var s, o, a, l, h = t.length,
                    c = 0,
                    u = h - 2;
                for (i *= 6, o = 0; h > o; o += 6) l = t[s = (o + i) % u] - (e[o] - n), a = t[s + 1] - (e[o + 1] - r), c += Math.sqrt(a * a + l * l);
                return c
            },
            x = function(t, e, i) {
                var n, r, s, o = t.length,
                    ...
                    u = b(t, e, 0, h, c),
                    f = 0;
                for (s = 6; o > s; s += 6) u > (r = b(t, e, s / 6, h, c)) && (u = r, f = s);
                if (i)
                    for (n = t.slice(0), d(n), s = 6; o > s; s += 6) u > (r = b(n, e, s / 6, h, c)) && (u = r, f = -s);
                return f / 6
            },
            w = function(t, e, i) {
                for (var n, r, s, o, a, l, h = t.length, c = 99999999999, u = 0, f = 0; --h > -1;)
                    for (l = (n = t[h]).length, a = 0; l > a; a += 6) r = n[a] - e, s = n[a + 1] - i, c > (o = Math.sqrt(r * r + s * s)) && (c = o, u = n[a], f = n[a + 1]);
                return [u, f]
            },
            T = function(t, e, i, n, r, s) {
                var o, a, l, h, c = e.length,
                    u = 0,
                    f = Math.min(t.size || m(t), e[i].size || m(e[i])) * n,
                    d = 999999999999,
                    p = t.centerX + r,
                    g = t.centerY + s;
                for (o = i; c > o && !(f > (e[o].size || m(e[o]))); o++) a = e[o].centerX - p, l = e[o].centerY - g, d > (h = Math.sqrt(a * a + l * l)) && (u = o, d = h);
                return h = e[u], e.splice(u, 1), h
            },
            S = function(t, e, i, n) {
                var r, s, o, a, h, c, f, p = e.length - t.length,
                    b = p > 0 ? e : t,
                    S = p > 0 ? t : e,
                    C = 0,
                    P = "complexity" === n ? _ : v,
                    k = "position" === n ? 0 : "number" == typeof n ? n : .8,
                    E = S.length,
                    z = "object" == typeof i && i.push ? i.slice(0) : [i],
                    I = "reverse" === z[0] || z[0] < 0,
                    A = "log" === i;
                if (S[0]) {
                    if (b.length > 1 && (t.sort(P), e.sort(P), c = b.size || g(b), c = S.size || g(S), c = b.centerX - S.centerX, f = b.centerY - S.centerY, P === v))
                        for (E = 0; E < S.length; E++) b.splice(E, 0, T(S[E], b, E, k, c, f));
                    if (p)
                        for (0 > p && (p = -p), b[0].length > S[0].length && u(S[0], (b[0].length - S[0].length) / 6 | 0), E = S.length; p > C;) b[E].size || m(b[E]), a = (o = w(S, b[E].centerX, b[E].centerY))[0], h = o[1], S[E++] = [a, h, a, h, a, h, a, h], S.totalPoints += 8, C++;
                    for (E = 0; E < t.length; E++) r = e[E], s = t[E], 0 > (p = r.length - s.length) ? u(r, -p / 6 | 0) : p > 0 && u(s, p / 6 | 0), I && !s.reversed && d(s), (i = z[E] || 0 === z[E] ? z[E] : "auto") && (s.closed || Math.abs(s[0] - s[s.length - 2]) < .5 && Math.abs(s[1] - s[s.length - 1]) < .5 ? "auto" === i || "log" === i ? (z[E] = i = x(s, r, 0 === E), 0 > i && (I = !0, d(s), i = -i), y(s, 6 * i)) : "reverse" !== i && (E && 0 > i && d(s), y(s, 6 * (0 > i ? -i : i))) : !I && ("auto" === i && Math.abs(r[0] - s[0]) + Math.abs(r[1] - s[1]) + Math.abs(r[r.length - 2] - s[s.length - 2]) + Math.abs(r[r.length - 1] - s[s.length - 1]) > Math.abs(r[0] - s[s.length - 2]) + Math.abs(r[1] - s[s.length - 1]) + Math.abs(r[r.length - 2] - s[0]) + Math.abs(r[r.length - 1] - s[1]) || i % 2) ? (d(s), z[E] = -1, I = !0) : "auto" === i ? z[E] = 0 : "reverse" === i && (z[E] = -1), s.closed !== r.closed && (s.closed = r.closed = !1));
                    return A && l("shapeIndex:[" + z.join(",") + "]"), z
                }
            },
            C = function(t, e, i, n) {
                var r = c(t[0]),
                    s = c(t[1]);
                S(r, s, e || 0 === e ? e : "auto", i) && (t[0] = f(r), t[1] = f(s), ("log" === n || !0 === n) && l('precompile:["' + t[0] + '","' + t[1] + '"]'))
            },
            P = function(t, e) {
                var i, n, r, s, o, a, l, h = 0,
                    c = parseFloat(t[0]),
                    u = parseFloat(t[1]),
                    f = c + "," + u + " ",
                    d = .999999;
                for (i = .5 * e / (.5 * (r = t.length) - 1), n = 0; r - 2 > n; n += 2) {
                    if (h += i, a = parseFloat(t[n + 2]), l = parseFloat(t[n + 3]), h > d)
                        for (o = 1 / (Math.floor(h) + 1), s = 1; h > d;) f += (c + (a - c) * o * s).toFixed(2) + "," + (u + (l - u) * o * s).toFixed(2) + " ", h--, s++;
                    f += a + "," + l + " ", c = a, u = l
                }
                return f
            },
            k = function(t) {
                var e = t[0].match(n) || [],
                    i = t[1].match(n) || [],
                    r = i.length - e.length;
                r > 0 ? t[0] = P(e, r) : t[1] = P(i, -r)
            },
            E = function(t) {
                return isNaN(t) ? k : function(e) {
                    k(e), e[1] = function(t, e) {
                        if (!e) return t;
                        var i, r, s, o = t.match(n) || [],
                            a = o.length,
                            l = "";
                        for ("reverse" === e ? (r = a - 1, i = -2) : (r = (2 * (parseInt(e, 10) || 0) + 1 + 100 * a) % a, i = 2), s = 0; a > s; s += 2) l += o[r - 1] + "," + o[r] + " ", r = (r + i) % a;
                        return l
                    }(e[1], parseInt(t, 10))
                }
            },
            z = function(t, e) {
                var i, r, s, o, a, l, h, u, d, p, m, g, _, v, y, b, x, w, T, S, C, P = t.tagName.toLowerCase(),
                    k = .552284749831;
                return "path" !== P && t.getBBox ? (l = function(t, e) {
                    ...
                    return n
                }(t, "x,y,width,height,cx,cy,rx,ry,r,x1,x2,y1,y2,points"), "rect" === P ? (o = +t.getAttribute("rx") || 0, a = +t.getAttribute("ry") || 0, r = +t.getAttribute("x") || 0, s = +t.getAttribute("y") || 0, p = (+t.getAttribute("width") || 0) - 2 * o, m = (+t.getAttribute("height") || 0) - 2 * a, o || a ? i = "M" + (b = (v = (_ = r + o) + p) + o) + "," + (w = s + a) + " V" + (T = w + m) + " C" + [b, S = T + a * k, y = v + o * k, C = T + a, v, C, v - (v - _) / 3, C, _ + (v - _) / 3, C, _, C, g = r + o * (1 - k), C, r, S, r, T, r, T - (T - w) / 3, r, w + (T - w) / 3, r, w, r, x = s + a * (1 - k), g, s, _, s, _ + (v - _) / 3, s, v - (v - _) / 3, s, v, s, y, s, b, x, b, w].join(",") + "z" : i = "M" + (r + p) + "," + s + " v" + m + " h" + -p + " v" + -m + " h" + p + "z") : "circle" === P || "ellipse" === P ? ("circle" === P ? u = (o = a = +t.getAttribute("r") || 0) * k : (o = +t.getAttribute("rx") || 0, u = (a = +t.getAttribute("ry") || 0) * k), i = "M" + ((r = +t.getAttribute("cx") || 0) + o) + "," + (s = +t.getAttribute("cy") || 0) + " C" + [r + o, s + u, r + (h = o * k), s + a, r, s + a, r - h, s + a, r - o, s + u, r - o, s, r - o, s - u, r - h, s - a, r, s - a, r + h, s - a, r + o, s - u, r + o, s].join(",") + "z") : "line" === P ? i = f(c("M" + (t.getAttribute("x1") || 0) + "," + (t.getAttribute("y1") || 0) + " L" + (t.getAttribute("x2") || 0) + "," + (t.getAttribute("y2") || 0))) : ("polyline" === P || "polygon" === P) && (i = "M" + (r = (d = (t.getAttribute("points") + "").match(n) || []).shift()) + "," + (s = d.shift()) + " L" + d.join(","), "polygon" === P && (i += "," + r + "," + s + "z")), l.setAttribute("d", i), e && t.parentNode && (t.parentNode.insertBefore(l, t), t.parentNode.removeChild(t)), l) : t
            },
            I = function(t, e, i) { var s, o, h = "string" == typeof t; return (!h || r.test(t) || (t.match(n) || []).length < 3) && ((s = h ? a.selector(t) : t && t[0] ? t : [t]) && s[0] ? (o = (s = s[0]).nodeName.toUpperCase(), e && "PATH" !== o && (s = z(s, !1), o = "PATH"), t = s.getAttribute("PATH" === o ? "d" : "points") || "", s === i && (t = s.getAttributeNS(null, "data-original") || t)) : (l("WARNING: invalid morph to: " + t), t = !1)), t },
            A = "Use MorphSVGPlugin.convertToPath(elementOrSelectorText) to convert to a path before morphing.",
            O = _gsScope._gsDefine.plugin({
                propName: "morphSVG",
                API: 2,
                global: !0,
                version: "0.8.11",
                init: function(t, e, i, n) { var r, o, a, h, c; return "function" == typeof t.setAttribute && ("function" == typeof e && (e = e(n, t)), c = "POLYLINE" === (r = t.nodeName.toUpperCase()) || "POLYGON" === r, "PATH" === r || c ? (o = "PATH" === r ? "d" : "points", ("string" == typeof e || e.getBBox || e[0]) && (e = { shape: e }), h = I(e.shape || e.d || e.points || "", "d" === o, t), c && s.test(h) ? (l("WARNING: a <" + r + "> cannot accept path data. " + A), !1) : (h && (this._target = t, t.getAttributeNS(null, "data-original") || t.setAttributeNS(null, "data-original", t.getAttribute(o)), (a = this._addTween(t, "setAttribute", t.getAttribute(o) + "", h + "", "morphSVG", !1, o, "object" == typeof e.precompile ? function(t) { t[0] = e.precompile[0], t[1] = e.precompile[1] } : "d" === o ? function(t, e, i) { return e || i || t || 0 === t ? function(n) { C(n, t, e, i) } : C }(e.shapeIndex, e.map || O.defaultMap, e.precompile) : E(e.shapeIndex))) && (this._overwriteProps.push("morphSVG"), a.end = h, a.endProp = o)), !0)) : (l("WARNING: cannot morph a <" + r + "> SVG element. " + A), !1)) },
                set: function(t) {
                    var e;
        ...
        O.pathFilter = C, O.pointsFilter = k, O.subdivideRawBezier = u, O.defaultMap = "size", O.pathDataToRawBezier = function(t) { return c(I(t, !0)) }, O.equalizeSegmentQuantity = S, O.convertToPath = function(t, e) { "string" == typeof t && (t = a.selector(t)); for (var i = t && 0 !== t.length ? t.length && t[0] && t[0].nodeType ? Array.prototype.slice.call(t, 0) : [t] : [], n = i.length; --n > -1;) i[n] = z(i[n], !1 !== e); return i }, O.pathDataToBezier = function(t, e) {
            var i, n, r, s, o, l, h, u, f = c(I(t, !0))[0] || [],
                d = 0;
            if (u = (e = e || {}).align || e.relative, s = e.matrix || [1, 0, 0, 1, 0, 0], o = e.offsetX || 0, l = e.offsetY || 0, "relative" === u || !0 === u ? (o -= f[0] * s[0] + f[1] * s[2], l -= f[0] * s[1] + f[1] * s[3], d = "+=") : (o += s[4], l += s[5], u && ((u = "string" == typeof u ? a.selector(u) : u && u[0] ? u : [u]) && u[0] && (o -= (h = u[0].getBBox() || { x: 0, y: 0 }).x, l -= h.y))), i = [], r = f.length, s && "1,0,0,1,0,0" !== s.join(","))
                for (n = 0; r > n; n += 2) i.push({ x: d + (f[n] * s[0] + f[n + 1] * s[2] + o), y: d + (f[n] * s[1] + f[n + 1] * s[3] + l) });
            else
                for (n = 0; r > n; n += 2) i.push({ x: d + (f[n] + o), y: d + (f[n + 1] + l) });
            return i
        }
    })), _gsScope._gsDefine && _gsScope._gsQueue.pop()(), function(t) { "use strict"; var e = function() { return (_gsScope.GreenSockGlobals || _gsScope).MorphSVGPlugin }; "undefined" != typeof module && module.exports ? (require("../TweenLite.min.js"), module.exports = e()) : "function" == typeof define && define.amd && define(["TweenLite"], e) }(), function() {
        "use strict";
        ...
        function t() {
            ...
            if (!("scrollBehavior" in e.documentElement.style) || !0 === t.__forceSmoothScrollPolyfill__) {
                var i, n = t.HTMLElement || t.Element,
                    r = 468,
                    s = { scroll: t.scroll || t.scrollTo, scrollBy: t.scrollBy, elementScroll: n.prototype.scroll || l, scrollIntoView: n.prototype.scrollIntoView },
                ...
                t.scroll = t.scrollTo = function() { void 0 !== arguments[0] && (!0 !== h(arguments[0]) ? d.call(t, e.body, void 0 !== arguments[0].left ? ~~arguments[0].left : t.scrollX || t.pageXOffset, void 0 !== arguments[0].top ? ~~arguments[0].top : t.scrollY || t.pageYOffset) : s.scroll.call(t, void 0 !== arguments[0].left ? arguments[0].left : "object" != typeof arguments[0] ? arguments[0] : t.scrollX || t.pageXOffset, void 0 !== arguments[0].top ? arguments[0].top : void 0 !== arguments[1] ? arguments[1] : t.scrollY || t.pageYOffset)) }, t.scrollBy = function() { void 0 !== arguments[0] && (h(arguments[0]) ? s.scrollBy.call(t, void 0 !== arguments[0].left ? arguments[0].left : "object" != typeof arguments[0] ? arguments[0] : 0, void 0 !== arguments[0].top ? arguments[0].top : void 0 !== arguments[1] ? arguments[1] : 0) : d.call(t, e.body, ~~arguments[0].left + (t.scrollX || t.pageXOffset), ~~arguments[0].top + (t.scrollY || t.pageYOffset))) }, n.prototype.scroll = n.prototype.scrollTo = function() {
                ...
                }, n.prototype.scrollBy = function() { void 0 !== arguments[0] && (!0 !== h(arguments[0]) ? this.scroll({ left: ~~arguments[0].left + this.scrollLeft, top: ~~arguments[0].top + this.scrollTop, behavior: arguments[0].behavior }) : s.elementScroll.call(this, void 0 !== arguments[0].left ? ~~arguments[0].left + this.scrollLeft : ~~arguments[0] + this.scrollLeft, void 0 !== arguments[0].top ? ~~arguments[0].top + this.scrollTop : ~~arguments[1] + this.scrollTop)) }, n.prototype.scrollIntoView = function() {
                    if (!0 !== h(arguments[0])) {
                        var i = function(t) {
                                var i, n, r, s;
                                do { i = (t = t.parentNode) === e.body } while (!1 === i && !1 === (r = c(n = t, "Y") && u(n, "Y"), s = c(n, "X") && u(n, "X"), r || s));
                                return i = null, t
                            }(this),
                            n = i.getBoundingClientRect(),
                            r = this.getBoundingClientRect();
                        i !== e.body ? (d.call(this, i, i.scrollLeft + r.left - n.left, i.scrollTop + r.top - n.top), "fixed" !== t.getComputedStyle(i).position && t.scrollBy({ left: n.left, top: n.top, behavior: "smooth" })) : t.scrollBy({ left: r.left, top: r.top, behavior: "smooth" })
            ...
            function c(t, e) { return "Y" === e ? t.clientHeight + a < t.scrollHeight : "X" === e ? t.clientWidth + a < t.scrollWidth : void 0 }
            ...
            function d(i, n, r) {
                var a, h, c, u, d = o();
                i === e.body ? (a = t, h = t.scrollX || t.pageXOffset, c = t.scrollY || t.pageYOffset, u = s.scroll) : (a = i, h = i.scrollLeft, c = i.scrollTop, u = l), f({ scrollable: a, method: u, startTime: d, startX: h, startY: c, x: n, y: r })
            }
        }
        "object" == typeof exports && "undefined" != typeof module ? module.exports = { polyfill: t } : t()
    }(), function t(e, i, n) {
        function r(o, a) {
            if (!i[o]) {
                if (!e[o]) { var l = "function" == typeof require && require; if (!a && l) return l(o, !0); if (s) return s(o, !0); var h = new Error("Cannot find module '" + o + "'"); throw h.code = "MODULE_NOT_FOUND", h }
                var c = i[o] = { exports: {} };
                e[o][0].call(c.exports, (function(t) { return r(e[o][1][t] || t) }), c, c.exports, t, e, i, n)
            }
            return i[o].exports
        }
        ...
        1: [function(t, e, i) {
            ! function(t, n) {
                ...
                else if (void 0 !== i && void 0 !== e) n(i, e);
                else {
                    var r = { exports: {} };
                    n(r.exports, r), t.fetchJsonp = r.exports
                }
            }(this, (function(t, e) {
                "use strict";
                var i = 5e3,
        ...
        2: [function(t, e, i) {
            ...
            function s(t, e) {
                ...
                0 !== t._state ? (t._handled = !0, c._immediateFn((function() {
                    ...
                    if (null !== i) {
                        var n;
                        try { n = i(t._value) } catch (t) { return void a(e.promise, t) }
                        o(e.promise, n)
                    } else(1 === t._state ? o : a)(e.promise, t._value)
                }))) : t._deferreds.push(e)
            }
            ...
            function o(t, e) {
                try {
                    ...
                    if (e && ("object" == typeof e || "function" == typeof e)) { var i = e.then; if (e instanceof c) return t._state = 3, t._value = e, void l(t); if ("function" == typeof i) return void h((n = i, r = e, function() { n.apply(r, arguments) }), t) }
            ...
            function l(t) {
                2 === t._state && 0 === t._deferreds.length && c._immediateFn((function() { t._handled || c._unhandledRejectionFn(t._value) }));
            ...
            function h(t, e) {
                var i = !1;
                try { t((function(t) { i || (i = !0, o(e, t)) }), (function(t) { i || (i = !0, a(e, t)) })) } catch (t) {
                    if (i) return;
                    i = !0, a(e, t)
                }
            }
            ...
            var u = c.prototype;
            u.catch = function(t) { return this.then(null, t) }, u.then = function(t, e) { var i = new this.constructor(r); return s(this, new function(t, e, i) { this.onFulfilled = "function" == typeof t ? t : null, this.onRejected = "function" == typeof e ? e : null, this.promise = i }(t, e, i)), i }, c.all = function(t) {
                return new c((function(e, i) {
                    ...
                    function s(t, o) {
                        try {
                            if (o && ("object" == typeof o || "function" == typeof o)) { var a = o.then; if ("function" == typeof a) return void a.call(o, (function(e) { s(t, e) }), i) }
                            n[t] = o, 0 == --r && e(n)
                        } catch (t) { i(t) }
                    }
                    for (var o = 0; o < n.length; o++) s(o, n[o])
                }))
            }, c.resolve = function(t) { return t && "object" == typeof t && t.constructor === c ? t : new c((function(e) { e(t) })) }, c.reject = function(t) { return new c((function(e, i) { i(t) })) }, c.race = function(t) { return new c((function(e, i) { for (var n = 0, r = t.length; n < r; n++) t[n].then(e, i) })) }, c._immediateFn = "function" == typeof setImmediate && function(t) { setImmediate(t) } || function(t) { n(t, 0) }, c._unhandledRejectionFn = function(t) { "undefined" != typeof console && console && console.warn("Possible Unhandled Promise Rejection:", t) }, e.exports = c
        }, {}],
        3: [function(t, e, i) {
            "use strict";
            var n = s(t("promise-polyfill")),
                r = s(t("fetch-jsonp"));

            function s(t) { return t && t.__esModule ? t : { default: t } }
            var o = {},
                a = !!document.querySelector && !!document.addEventListener,
                l = void 0,
                h = void 0,
                c = void 0,
                u = void 0,
                ...
                m = void 0,
                g = void 0,
                _ = { accessToken: null, target: "instafetch", numOfPics: 20, caption: !1 },
                v = function(t, e, i) {
            ...
            o.destroy = function() { l && (l = null, h = null, c = null, u = null, f = null, d = null, p = null, m = null, g = null) }, o.init = function(t) {
                var e, i;
                a && (o.destroy(), ("string" != typeof(e = l = function(t, e) { var i = {}; return v(t, (function(e, n) { i[n] = t[n] })), v(e, (function(t, n) { i[n] = e[n] })), i }(_, t || {})).accessToken ? (console.error("accessToken must be a string."), 0) : "string" != typeof e.target ? (console.error("target must be a string."), 0) : "number" != typeof e.numOfPics ? (console.error("numOfPics must be a number."), 0) : "boolean" == typeof e.caption || (console.error("caption must be a boolean."), 0)) && (h = "https://api.instagram.com/v1/users/self/media/recent/?access_token=" + (i = l).accessToken + "&count=" + i.numOfPics + "&callback=?", window.Promise || (window.Promise = n.default), (0, r.default)(h).then((function(t) { return t.json() })).then((function(t) {
                    200 === t.meta.code ? function(t, e) {
                        (c = document.getElementById(e.target)) ? t.data.forEach((function(t) { u = document.createElement("article"), (f = document.createElement("a")).href = t.link, f.target = "_blank", d = document.createElement("figure"), (p = document.createElement("img")).src = t.images.standard_resolution.url, d.appendChild(p), f.appendChild(d), u.appendChild(f), e.caption && t.caption && (m = document.createElement("div"), (g = document.createElement("p")).innerHTML = t.caption.text, m.appendChild(g), f.appendChild(m)), c.appendChild(u) })): console.error('No element with id="' + e.target + '" was found on the page.')
                    }(t, i) : console.error(t.meta.error_message)
                })).catch((function(t) { console.error(t) }))))
            }, window.instafetch = o
        }, { "fetch-jsonp": 1, "promise-polyfill": 2 }]
    }, {}, [3]), function(t) { "function" == typeof define && define.amd ? define(["jquery"], t) : "object" == typeof exports ? t(require("jquery")) : t(window.jQuery || window.Zepto) }((function(t) {
        var e, i, n, r, s, o, a = function() {},
            l = !!window.jQuery,
            h = t(window),
            c = function(t, i) { e.ev.on("mfp" + t + ".mfp", i) },
            u = function(e, i, n, r) { var s = document.createElement("div"); return s.className = "mfp-" + e, n && (s.innerHTML = n), r ? i && i.appendChild(s) : (s = t(s), i && s.appendTo(i)), s },
            f = function(i, n) { e.ev.triggerHandler("mfp" + i, n), e.st.callbacks && (i = i.charAt(0).toLowerCase() + i.slice(1), e.st.callbacks[i] && e.st.callbacks[i].apply(e, t.isArray(n) ? n : [n])) },
            d = function(i) { return i === o && e.currTemplate.closeBtn || (e.currTemplate.closeBtn = t(e.st.closeMarkup.replace("%title%", e.st.tClose)), o = i), e.currTemplate.closeBtn },
            p = function() { t.magnificPopup.instance || ((e = new a).init(), t.magnificPopup.instance = e) };
        a.prototype = {
            constructor: a,
            init: function() {
            ...
            open: function(i) {
                ...
                if (!1 === i.isObj) {
                    ...
                    for (r = 0; r < a.length; r++)
                        if ((o = a[r]).parsed && (o = o.el[0]), o === i.el[0]) { e.index = r; break }
            ...
            close: function() { e.isOpen && (f("BeforeClose"), e.isOpen = !1, e.st.removalDelay && !e.isLowIE && e.supportsTransition ? (e._addClassToMFP("mfp-removing"), setTimeout((function() { e._close() }), e.st.removalDelay)) : e._close()) },
            _close: function() {
                f("Close");
            ...
            appendContent: function(t, i) { e.content = t, t ? e.st.showCloseBtn && e.st.closeBtnInside && !0 === e.currTemplate[i] ? e.content.find(".mfp-close").length || e.content.append(d()) : e.content = t : e.content = "", f("BeforeAppend"), e.container.addClass("mfp-" + i + "-holder"), e.contentContainer.append(e.content) },
            parseEl: function(i) {
                var n, r = e.items[i];
                if (r.tagName ? r = { el: t(r) } : (n = r.type, r = { data: r, src: r.src }), r.el) {
                    for (var s = e.types, o = 0; o < s.length; o++)
                        if (r.el.hasClass("mfp-" + s[o])) { n = s[o]; break }
            ...
            _openClick: function(i, n, r) {
                if ((void 0 !== r.midClick ? r.midClick : t.magnificPopup.defaults.midClick) || !(2 === i.which || i.ctrlKey || i.metaKey || i.altKey || i.shiftKey)) {
                    ...
                    if (s)
                        if (t.isFunction(s)) { if (!s.call(e)) return !0 } else if (h.width() < s) return !0;
            ...
            updateStatus: function(t, n) {
                if (e.preloader) {
                    ...
                    f("UpdateStatus", r), t = r.status, n = r.text, e.preloader.html(n), e.preloader.find("a").on("click", (function(t) { t.stopImmediatePropagation() })), e.container.addClass("mfp-s-" + t), i = t
                }
            },
            ...
            _hasScrollBar: function(t) { return (e.isIE7 ? n.height() : document.body.scrollHeight) > (t || h.height()) },
            _setFocus: function() {
            ...
            _parseMarkup: function(e, i, n) {
                var r;
                n.data && (i = t.extend(n.data, i)), f("MarkupParse", [e, i, n]), t.each(i, (function(i, n) { if (void 0 === n || !1 === n) return !0; if ((r = i.split("_")).length > 1) { var s = e.find(".mfp-" + r[0]); if (s.length > 0) { var o = r[1]; "replaceWith" === o ? s[0] !== n[0] && s.replaceWith(n) : "img" === o ? s.is("img") ? s.attr("src", n) : s.replaceWith(t("<img>").attr("src", n).attr("class", s.attr("class"))) : s.attr(r[1], n) } } else e.find(".mfp-" + i).html(n) }))
            },
        ...
        var m, g, _, v = function() { _ && (g.after(_.addClass(m)).detach(), _ = null) };
        t.magnificPopup.registerModule("inline", {
            options: { hiddenClass: "hide", markup: "", tNotFound: "Content not found" },
            proto: {
                initInline: function() { e.types.push("inline"), c("Close.inline", (function() { v() })) },
                getInline: function(i, n) {
                    if (v(), i.src) {
                        ...
                        if (s.length) {
                            ...
                            o && o.tagName && (g || (m = r.hiddenClass, g = u(m), m = "mfp-" + m), _ = s.after(g).detach().removeClass(m)), e.updateStatus("ready")
        ...
        var y, b = function() { y && t(document.body).removeClass(y) },
            x = function() { b(), e.req && e.req.abort() };
        t.magnificPopup.registerModule("ajax", {
            options: { settings: null, cursor: "mfp-ajax-cur", tError: '<a href="%url%">The content</a> could not be loaded.' },
            proto: {
                initAjax: function() { e.types.push("ajax"), y = e.st.ajax.cursor, c("Close.ajax", x), c("BeforeChange.ajax", x) },
                getAjax: function(i) {
                    ...
                    var n = t.extend({
                        ...
                        success: function(n, r, s) {
                            var o = { data: n, xhr: s };
                            f("ParseAjax", o), e.appendContent(t(o.data), "ajax"), i.finished = !0, b(), e._setFocus(), setTimeout((function() { e.wrap.addClass("mfp-ready") }), 16), e.updateStatus("ready"), f("AjaxContentAdded")
                        },
        ...
        var w, T = function(i) { if (i.data && void 0 !== i.data.title) return i.data.title; var n = e.st.image.titleSrc; if (n) { if (t.isFunction(n)) return n.call(e, i); if (i.el) return i.el.attr(n) || "" } return "" };
        t.magnificPopup.registerModule("image", {
            ...
            proto: {
                initImage: function() {
                    var i = e.st.image,
                        n = ".image";
                    e.types.push("image"), c("Open" + n, (function() { "image" === e.currItem.type && i.cursor && t(document.body).addClass(i.cursor) })), c("Close" + n, (function() { i.cursor && t(document.body).removeClass(i.cursor), h.off("resize.mfp") })), c("Resize" + n, e.resizeImage), e.isLowIE && c("AfterChange", e.resizeImage)
                },
                ...
                _onImageHasSize: function(t) { t.img && (t.hasSize = !0, w && clearInterval(w), t.isCheckingImgSize = !1, f("ImageHasSize", t), t.imgHidden && (e.content && e.content.removeClass("mfp-loading"), t.imgHidden = !1)) },
                findImageSize: function(t) {
                    var i = 0,
                        n = t.img[0],
                        r = function(s) { w && clearInterval(w), w = setInterval((function() { n.naturalWidth > 0 ? e._onImageHasSize(t) : (i > 200 && clearInterval(w), 3 === ++i ? r(10) : 40 === i ? r(50) : 100 === i && r(500)) }), s) };
                    r(1)
                },
                getImage: function(i, n) {
                    var r = 0,
                        s = function() { i && (i.img[0].complete ? (i.img.off(".mfploader"), i === e.currItem && (e._onImageHasSize(i), e.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, f("ImageLoadComplete")) : ++r < 200 ? setTimeout(s, 100) : o()) },
                        o = function() { i && (i.img.off(".mfploader"), i === e.currItem && (e._onImageHasSize(i), e.updateStatus("error", a.tError.replace("%url%", i.src))), i.hasSize = !0, i.loaded = !0, i.loadError = !0) },
                        a = e.st.image,
                        l = n.find(".mfp-img");
                    if (l.length) {
                        var h = document.createElement("img");
                        h.className = "mfp-img", i.el && i.el.find("img").length && (h.alt = i.el.find("img").attr("alt")), i.img = t(h).on("load.mfploader", s).on("error.mfploader", o), h.src = i.src, l.is("img") && (i.img = i.img.clone()), (h = i.img[0]).naturalWidth > 0 ? i.hasSize = !0 : h.width || (i.hasSize = !1)
                    }
        ...
        t.magnificPopup.registerModule("zoom", {
            ...
            proto: {
                    ...
                    if (i.enabled && e.supportsTransition) {
                        ...
                        c("BuildControls" + n, (function() {
                            if (e._allowZoom()) {
                                ...
                                (s = a(t)).css(e._getOffset()), e.wrap.append(s), r = setTimeout((function() { s.css(e._getOffset(!0)), r = setTimeout((function() { l(), setTimeout((function() { s.remove(), t = s = null, f("ZoomAnimationEnded") }), 16) }), o) }), 16)
                            }
                        ...
                        })), c("Close" + n, (function() { e._allowZoom() && (l(), s && s.remove(), t = null) }))
                    }
                },
                ...
                _getOffset: function(i) {
                    ...
                    var a = { width: n.width(), height: (l ? n.innerHeight() : n[0].offsetHeight) - o - s };
        ...
        t.magnificPopup.registerModule("iframe", {
            ...
            proto: {
                initIframe: function() { e.types.push("iframe"), c("BeforeChange", (function(t, e, i) { e !== i && ("iframe" === e ? C() : "iframe" === i && C(!0)) })), c("Close.iframe", (function() { C() })) },
                getIframe: function(i, n) {
                    var r = i.src,
                        s = e.st.iframe;
                    t.each(s.patterns, (function() { if (r.indexOf(this.index) > -1) return this.id && (r = "string" == typeof this.id ? r.substr(r.lastIndexOf(this.id) + this.id.length, r.length) : this.id.call(this, r)), r = this.src.replace("%id%", r), !1 }));
                    var o = {};
                    return s.srcAction && (o[s.srcAction] = r), e._parseMarkup(n, o, i), e.updateStatus("ready"), n
                }
            }
        });
        var P = function(t) { var i = e.items.length; return t > i - 1 ? t - i : t < 0 ? i + t : t },
            ...
            proto: {
                initGallery: function() {
                    ...
                    s += " mfp-gallery", c("Open" + r, (function() { i.navigateByImgClick && e.wrap.on("click" + r, ".mfp-img", (function() { if (e.items.length > 1) return e.next(), !1 })), n.on("keydown" + r, (function(t) { 37 === t.keyCode ? e.prev() : 39 === t.keyCode && e.next() })) })), c("UpdateStatus" + r, (function(t, i) { i.text && (i.text = k(i.text, e.currItem.index, e.items.length)) })), c("MarkupParse" + r, (function(t, n, r, s) {
                        ...
                        if (e.items.length > 1 && i.arrows && !e.arrowLeft) {
                            ...
                            r.click((function() { e.prev() })), s.click((function() { e.next() })), e.container.append(r.add(s))
                        }
                    })), c("Change" + r, (function() { e._preloadTimeout && clearTimeout(e._preloadTimeout), e._preloadTimeout = setTimeout((function() { e.preloadNearbyImages(), e._preloadTimeout = null }), 16) })), c("Close" + r, (function() { n.off(r), e.wrap.off("click" + r), e.arrowRight = e.arrowLeft = null }))
                },
                next: function() { e.direction = !0, e.index = P(e.index + 1), e.updateItemHTML() },
                prev: function() { e.direction = !1, e.index = P(e.index - 1), e.updateItemHTML() },
                ...
                _preloadItem: function(i) {
                    if (i = P(i), !e.items[i].preloaded) {
                        var n = e.items[i];
                        n.parsed || (n = e.parseEl(i)), f("LazyLoad", n), "image" === n.type && (n.img = t('<img class="mfp-img" />').on("load.mfploader", (function() { n.hasSize = !0 })).on("error.mfploader", (function() { n.hasSize = !0, n.loadError = !0, f("LazyLoadError", n) })).attr("src", n.src)), n.preloaded = !0
                    }
                }
            }
        });
            ...
            proto: {
                initRetina: function() {
                    if (window.devicePixelRatio > 1) {
                        var t = e.st.retina,
                            i = t.ratio;
                        (i = isNaN(i) ? i() : i) > 1 && (c("ImageHasSize.retina", (function(t, e) { e.img.css({ "max-width": e.img[0].naturalWidth / i, width: "100%" }) })), c("ElementParse.retina", (function(e, n) { n.src = t.replaceSrc(n, i) })))
                    }
                }
            }
        }), p()
        ...
        var n = document.documentElement.style,
            ...
            a = { transform: s, transition: r, transitionDuration: r + "Duration", transitionProperty: r + "Property", transitionDelay: r + "Delay" },
        ...
        l.constructor = i, l._create = function() { this._transn = { ingProperties: {}, clean: {}, onEnd: {} }, this.css({ position: "absolute" }) }, l.handleEvent = function(t) {
            ...
            if (this.setPosition(t, e), !r || this.isTransitioning) {
                var s = t - i,
                    o = e - n,
                    a = {};
                a.transform = this.getTranslate(s, o), this.transition({ to: a, onTransitionEnd: { transform: this.layoutPosition }, isCleaning: !0 })
        ...
        l.ontransitionend = function(t) {
            if (t.target === this.element) {
                ...
                if (delete e.ingProperties[i], function(t) { for (var e in t) return !1; return null, !0 }(e.ingProperties) && this.disableTransition(), i in e.clean && (this.element.style[t.propertyName] = "", delete e.clean[i]), i in e.onEnd) e.onEnd[i].call(this), delete e.onEnd[i];
    ...
    })), function(t, e) { "use strict"; "function" == typeof define && define.amd ? define("outlayer/outlayer", ["ev-emitter/ev-emitter", "get-size/get-size", "fizzy-ui-utils/utils", "./item"], (function(i, n, r, s) { return e(t, i, n, r, s) })) : "object" == typeof module && module.exports ? module.exports = e(t, require("ev-emitter"), require("get-size"), require("fizzy-ui-utils"), require("./item")) : t.Outlayer = e(t, t.EvEmitter, t.getSize, t.fizzyUIUtils, t.Outlayer.Item) }(window, (function(t, e, i, n, r) {
        "use strict";
        ...
        var a = t.console,
            ...
            c = 0,
            u = {};
        s.namespace = "outlayer", s.Item = r, s.defaults = { containerStyle: { position: "relative" }, initLayout: !0, originLeft: !0, originTop: !0, resize: !0, resizeContainer: !0, transitionDuration: "0.4s", hiddenStyle: { opacity: 0, transform: "scale(0.001)" }, visibleStyle: { opacity: 1, transform: "scale(1)" } };
        var f = s.prototype;
        ...
        }, f._positionItem = function(t, e, i, n, r) { n ? t.goTo(e, i) : (t.stagger(r * this.stagger), t.moveTo(e, i)) }, f._postLayout = function() { this.resizeContainer() }, f.resizeContainer = function() {
        ...
        }, f._find = function(t) { if (t) return "string" == typeof t && (t = this.element.querySelectorAll(t)), n.makeArray(t) }, f._manageStamps = function() { this.stamps && this.stamps.length && (this._getBoundingRect(), this.stamps.forEach(this._manageStamp, this)) }, f._getBoundingRect = function() {
        ...
        }, s.data = function(t) { var e = (t = n.getQueryElement(t)) && t.outlayerGUID; return e && u[e] }, s.create = function(t, e) { var i = o(s); return i.defaults = n.extend({}, s.defaults), n.extend(i.defaults, e), i.compatOptions = n.extend({}, s.compatOptions), i.namespace = t, i.data = s.data, i.Item = o(r), n.htmlInit(i, t), l && l.bridget && l.bridget(t, i), i };
        var d = { ms: 1, s: 1e3 };
        return s.Item = r, s
        ...
        var r = i.destroy;
        return i.destroy = function() { r.apply(this, arguments), this.css({ display: "" }) }, e
        ...
        return n._resetLayout = function() {
            ...
            for (var n = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](i, t), r = { x: this.columnWidth * n.col, y: n.y }, s = n.y + t.size.outerHeight, o = i + n.col, a = n.col; a < o; a++) this.colYs[a] = s;
            return r
        }, n._getTopColPosition = function(t) {
            var e = this._getTopColGroup(t),
                i = Math.min.apply(Math, e);
            return { col: e.indexOf(i), y: i }
        }, n._getTopColGroup = function(t) { if (t < 2) return this.colYs; for (var e = [], i = this.cols + 1 - t, n = 0; n < i; n++) e[n] = this._getColGroupY(n, t); return e }, n._getColGroupY = function(t, e) { if (e < 2) return this.colYs[t]; var i = this.colYs.slice(t, t + e); return Math.max.apply(Math, i) }, n._getHorizontalColPosition = function(t, e) {
        ...
        n.measureColumns = function() { this.items = this.isotope.filteredItems, o.call(this) };
        var a = n._getOption;
        ...
        c._create = function() { for (var t in this.itemGUID = 0, this._sorters = {}, this._getSorters(), e.prototype._create.call(this), this.modes = {}, this.filteredItems = this.items, this.sortHistory = ["original-order"], o.modes) this._initLayoutMode(t) }, c.reloadItems = function() { this.itemGUID = 0, e.prototype.reloadItems.call(this) }, c._itemize = function() {
            ...
            function t() { e && i && n && r.dispatchEvent("arrangeComplete", null, [r.filteredItems]) }
            var e, i, n, r = this;
        ...
        }, c._getFilterTest = function(t) { return a && this.options.isJQueryFiltering ? function(e) { return a(e.element).is(t) } : "function" == typeof t ? function(e) { return t(e.element) } : function(e) { return n(e.element, t) } }, c.updateSortData = function(t) {
            var e;
        ...
        var u = function(t) {
            ...
            var e = l(t).split(" "),
                i = e[0],
                n = i.match(/^\[(.+)\]$/),
                r = function(t, e) { return t ? function(e) { return e.getAttribute(t) } : function(t) { var i = t.querySelector(e); return i && i.textContent } }(n && n[1], i),
                s = h.sortDataParsers[e[1]];
            return s ? function(t) { return t && s(r(t)) } : function(t) { return t && r(t) }
        };
        ...
        return function e(i) {
            function n(e, r, s) {
                if ("undefined" != typeof document) {
                    if (arguments.length > 1) {
                        "number" == typeof(s = t({ path: "/" }, n.defaults, s)).expires && (s.expires = new Date(1 * new Date + 864e5 * s.expires)), s.expires = s.expires ? s.expires.toUTCString() : "";
                        try { var o = JSON.stringify(r); /^[\{\[]/.test(o) && (r = o) } catch (t) {}
                        r = i.write ? i.write(r, e) : encodeURIComponent(String(r)).replace(/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g, decodeURIComponent), e = encodeURIComponent(String(e)).replace(/%(23|24|26|2B|5E|60|7C)/g, decodeURIComponent).replace(/[\(\)]/g, escape);
                        var a = "";
                        for (var l in s) s[l] && (a += "; " + l, !0 !== s[l] && (a += "=" + s[l].split(";")[0]));
                        return document.cookie = e + "=" + r + a
                    }
                    for (var h = {}, c = function(t) { return t.replace(/(%[0-9A-Z]{2})+/g, decodeURIComponent) }, u = document.cookie ? document.cookie.split("; ") : [], f = 0; f < u.length; f++) {
                        var d = u[f].split("="),
                            p = d.slice(1).join("=");
                        this.json || '"' !== p.charAt(0) || (p = p.slice(1, -1));
                        try {
                            var m = c(d[0]);
                            if (p = (i.read || i)(p, m) || c(p), this.json) try { p = JSON.parse(p) } catch (t) {}
                            if (h[m] = p, e === m) break
                        } catch (t) {}
                    }
                    return e ? h[e] : h
            ...
            return n.set = n, n.get = function(t) { return n.call(n, t) }, n.getJSON = function() { return n.apply({ json: !0 }, arguments) }, n.remove = function(e, i) { n(e, "", t(i, { expires: -1 })) }, n.defaults = {}, n.withConverter = e, n
        }((function() {}))
    })), $(document).ready((function() {
        var t = $(".mobile-nav-trigger--open"),
            e = $(".mobile-nav-trigger--close"),
            i = $(".mobile-nav a");
        $body = $("body"), t.on("click", (function() { $body.addClass("mobile-nav-opened") })), e.on("click", (function() { $body.removeClass("mobile-nav-opened") })), i.on("click", (function() { $body.removeClass("mobile-nav-opened") })), $(".header a").on("click", (function(t) { t.shiftKey || t.ctrlKey || t.metaKey || $body.addClass("page-exit") })), $(".popup").magnificPopup({ type: "inline", midClick: !0 }), $(".hs-button, .button, button:not(.flickity-button), .team a").ripple(), inView.offset(200), inView(".will-animate").on("enter", (function(t) { t.classList.add("is-animated") }));
        new LazyLoad
    })), $(window).load((function() { $(".hs-submit .actions").ripple() })), $(".core-values").length) {
    var duration = 1,
        delay = 2,
        valueValues = new TimelineLite({ onComplete: repeat });

    function repeat() { valueValues.play(duration) }
    $(".core-values-value-text").each((function(t, e) {
        var i = 0 === t ? 0 : "-=" + duration;
        valueValues.to(e, duration, { autoAlpha: 1, repeat: 1, yoyo: !0, repeatDelay: delay }, i), t === $(".core-values-value-text").length - 1 && valueValues.to($(".core-values-value-text")[0], duration, { autoAlpha: 1 }, i)
    }));
    var coreValueIcons = new TimelineMax({ repeat: -1, delay: 1 }),
        gem = document.getElementById("gem");
    coreValueIcons.to(gem, 1, { morphSVG: "#spock" }, "+=2").to(gem, 1, { morphSVG: "#thumbsup" }, "+=2").to(gem, 1, { morphSVG: "#heart" }, "+=2").to(gem, 1, { morphSVG: "#handshake" }, "+=2").to(gem, 1, { morphSVG: gem }, "+=2");
    var coreValueColors = new TimelineMax({ repeat: -1, delay: 1 }),
        values = document.querySelector(".core-values-wrapper");
    coreValueColors.to(values, 1, { css: { color: "#f7ba96" } }, "+=2").to(values, 1, { css: { color: "#34C0CC" } }, "+=2").to(values, 1, { css: { color: "#e55c87" } }, "+=2").to(values, 1, { css: { color: "#74c485" } }, "+=2").to(values, 1, { css: { color: "#1468a1" } }, "+=2")
}
$(".faqs-item dt a").on("click", (function(t) { t.preventDefault(), $(this).parent().parent().hasClass("active") ? $(this).parent().parent().removeClass("active") : ($(".faqs-item.active").removeClass("active"), $(this).parent().parent().addClass("active")) })), $(".clients-think").length && (inView.offset(200), inView(".quick-wins").on("enter", (function() {
    var t = $.animateNumber.numberStepFactories.append("%");
    $(".quick-wins-callout-number").each((function() {
        var e = $(this),
            i = e.text();
        e.text("0%");
        e.animateNumber({ number: i, numberStep: t }, 1750)
    }))
})));
var $problemquestions = $(".icon-text-block-module__text-slider").flickity({ cellSelector: "li", pageDots: !1, adaptiveHeight: !0 });
if ($(".icon-text-block-module__text h3 a").on("click", (function(t) { t.preventDefault(), $(this).parent().parent().parent().hasClass("collapsed") ? ($(".icon-text-block-module").addClass("collapsed"), $(this).parent().parent().parent().removeClass("collapsed"), $problemquestions.flickity("resize")) : $(this).parent().parent().parent().addClass("collapsed") })), $("#instafetch").length && instafetch.init({ accessToken: "1350257.1677ed0.a58152c335c14e62ab225193889d6155", numOfPics: 12, caption: !1 }), $(".hero-2019__wrapper.multi-hero-image").length && $(".background-image-carousel__container").flickity({ cellAlign: "center", contain: !0, wrapAround: !0, prevNextButtons: !1, pageDots: !1, adaptiveHeight: !1, autoPlay: 6e3, draggable: !1, pauseAutoPlayOnHover: !1, cellSelector: ".js-slide" }), $(".custom-leadflow__custom-popup").length && $(".popup").magnificPopup({ type: "inline", midClick: !0 }), $(".pricing-page-2017").length) {
    $(".price-tab").appendTo(".price-tabs"), $(".price-panel").unwrap().unwrap();
    var Tabs = {
        init: function() { this.bindUIfunctions(), window.location.hash && this.pageLoadCorrectTab() },
        bindUIfunctions: function() { $(document).on("click", ".tabs a[href^='#']:not('.active')", (function(t) { Tabs.changeTab(this.hash), t.preventDefault() })).on("click", ".tabs a.active", (function(t) { Tabs.toggleMobileMenu(t, this), t.preventDefault() })) },
        changeTab: function(t) {
            var e = $("[href=" + t + "]"),
                i = $(t);
            e.addClass("active").parent().siblings().find("a").removeClass("active"), i.addClass("active").siblings().removeClass("active"), window.history.replaceState("", "", t), e.closest("ul").removeClass("open")
        },
        pageLoadCorrectTab: function() { this.changeTab(document.location.hash) },
        toggleMobileMenu: function(t, e) { $(e).closest("ul").toggleClass("open") }
    };
    Tabs.init();
    var $monthlyFees = $("#monthly-fees"),
        $monthlyFeesTotel = $("#monthly-fees-total"),
        $oneTimeFees = $("#one-time-fees"),
        $oneTimeFeesTotel = $("#monthly-fees-total");

    function removeInboundCore() { $("#inbound-core-list-item").remove(), monthlyTotal() }

    function monthlyTotal() {
        var t = 0;
        $("#monthly-fees .price").each((function() { t += Number(parseInt($(this).data("price"))) }));
        var e = $.animateNumber.numberStepFactories.separator(",");
        $("#monthly-fees-total span").animateNumber({ number: t, numberStep: e })
    }

    function oneTimeFeeTotal() {
        var t = 0;
        $("#one-time-fees .price").each((function() { t += Number(parseInt($(this).data("price"))) }));
        var e = $.animateNumber.numberStepFactories.separator(",");
        $("#one-time-fees-total span").animateNumber({ number: t, numberStep: e })
    }
    $(".price-panel-button").on("click", (function() {
        var t = $(this),
            e = t.data("name"),
            i = t.data("price"),
            n = (t.data("points"), t.data("tab"));
        1 == t.data("recurring") ? ($('<li class="price-summary-list-item" ><span class="title">' + e + ' <b>$<span class="price" data-price="' + i + '">' + i.toLocaleString() + '</span></b></span><i class="fa fa-times-circle remove-item" data-name="' + n + '"></i></li>').appendTo($monthlyFees), monthlyTotal()) : ($('<li class="price-summary-list-item" ><span class="title">' + e + ' <b>$<span class="price" data-price="' + i + '">' + i.toLocaleString() + '</span></b></span><i class="fa fa-times-circle remove-item" data-name="' + n + '" data-recurring="true"></i></li>').appendTo($oneTimeFees), "inbound-marketing-setup-standalone" == n ? removeInboundCore() : ($("#one-time-fee-modal").addClass("active"), $("#yes-to-inbound").on("click", (function() { $(this).parent().parent().parent().removeClass("active") })), $("#no-to-inbound").on("click", (function() { $(this).parent().parent().parent().removeClass("active"), removeInboundCore() }))), oneTimeFeeTotal()), $('.price-tab a[href="#' + n + '"]').addClass("added")
    })), $(".price-summary").on("click", ".remove-item", (function() {
        var t = $(this),
            e = t.data("recurring"),
            i = t.data("name");
        t.parent().remove(), oneTimeFeeTotal(), monthlyTotal(), $('.price-tab a[href="#' + i + '"]').removeClass("added"), "inbound-marketing-setup-standalone" != i && 1 != e || 0 == $("#inbound-core-list-item").length && ($('<li class="price-summary-list-item" id="inbound-core-list-item"><span class="title">Inbound Core <b>$<span class="price" data-price="6000">6,000</span></b></span></li>').appendTo($monthlyFees), monthlyTotal())
    })), $("#package-1").on("click", (function() { $('a[href="#advanced-content"]')[0].click(), $("#advanced-content .price-panel-button")[0].click(), $("#advanced-social-media .price-panel-button")[0].click(), $("#video-media .price-panel-button")[0].click(), $(this).attr("disabled", !0) })), $("#package-2").on("click", (function() { $('a[href="#growth-driven-design"]')[0].click(), $("#growth-driven-design .price-panel-button")[0].click(), $("#paid-media .price-panel-button")[0].click(), $("#trade-shows .price-panel-button")[0].click(), $(this).attr("disabled", !0) })), $("#package-3").on("click", (function() { $('a[href="#inbound-sales-development"]')[0].click(), $("#inbound-sales-development .price-panel-button")[0].click(), $("#inbound-sales-enablement .price-panel-button")[0].click(), $("#advanced-video-media .price-panel-button")[0].click(), $(this).attr("disabled", !0) })), $("#get-a-free-marketing-review").on("click", (function() {
        $("#pricing-modal").addClass("active");
        var t = $("#monthly-fees").text() + $("#one-time-fees").text();
        $('input[name="message"]').val(t)
    })), $(".popup-modal-close").on("click", (function() { $(this).parent().parent().removeClass("active") }))
}
if ($(".blog-listing-2018").length && $(".post-author-time").timeago(), $(".blog-post-2019").length) {
    function scrollBar() {
        ...
        document.getElementById("progressBar").style.width = t + "%"
    }

    function scrollToAnchor(t) {
        var e = $(t),
            i = $(".blog__sub-nav--wrapper.show-nav").height() + 100;
        if ((e = e.length ? e : $("[name=" + t.slice(1) + "]")).length) return $("html,body").animate({ scrollTop: e.offset().top - i }, 500), !1
    }
    $(".post-author-time").timeago(), $(".blog-comments .button-secondary").on("click", (function() { $(this).parent().toggleClass("active") })), window.onscroll = function() { scrollBar() }, $(window).scroll((function() { $(window).scrollTop() >= 500 ? $(".blog__sub-nav--wrapper").addClass("show-nav") : $(".blog__sub-nav--wrapper").removeClass("show-nav") })), $(".sub-nav__subscribe.hs-button").on("click", (function() { $(".subscribe-form__container").toggleClass("active") })), window.location.hash && scrollToAnchor(window.location.hash), $("a[href*=\\#]:not([href=\\#]):not(.popup)").click((function() { location.pathname.replace(/^\//, "") != this.pathname.replace(/^\//, "") && location.hostname != this.hostname || scrollToAnchor(this.hash) }))
}
if ($(".blog-listing-2019").length && $(".listing__pillar-resources").flickity({ cellAlign: "center", contain: !0, prevNextButtons: !0, pageDots: !1, imagesLoaded: !0, wrapAround: !0, adaptiveHeight: !0, autoPlay: 4e3, cellSelector: ".pillar-resources__container" }), $(".team-kobra-person, .team-unagi-person, .team-specialists-person").on("click", (function(t) {
        t.preventDefault(), $(".team-selected-item").addClass("hidden");
        var e = $(this).attr("href");
        $(e).removeClass("hidden"), document.querySelector(".team-selected").scrollIntoView({ behavior: "smooth" })
    })), $(".about-page__2019").length) {
    var $grid = $("#team-wrapper").isotope({ itemSelector: ".team-grid__item-container", layoutMode: "fitRows" }),
        filterFns = { numberGreaterThan50: function() { var t = $(this).find(".number").text(); return parseInt(t, 10) > 50 }, ium: function() { return $(this).find(".name").text().match(/ium$/) } };
    $(".team__filter-container").on("click", "button", (function() {
        var t = $(this).attr("data-filter");
        t = filterFns[t] || t, $grid.isotope({ filter: t })
    })), $(".team__filter-container").each((function(t, e) {
        var i = $(e);
        i.on("click", "button", (function() { i.find(".is-checked").removeClass("is-checked"), $(this).addClass("is-checked") }))
    })), $(".team-grid__item").on("click", (function(t) {
        t.preventDefault();
        var e = $(this).parents(".team-grid"),
            i = $("#team-wrapper");
        e.find(".team-grid__item-container").removeClass("is-selected"), $(this).parent().addClass("is-selected"), i.isotope("layout"), $(".team-grid__item-container").hasClass("is-selected") && $(".team-grid__exit").on("click", (function(t) { t.preventDefault(), $(this).parent().removeClass("is-selected"), i.isotope("layout") }))
    })), $(".team-grid__exit").on("click", (function(t) {
        t.preventDefault();
        var e = $("#team-wrapper");
        $(this).parent().parent().removeClass("is-selected"), e.isotope("layout")
    })), $(".team-grid__content").each((function() {
        $(".jsTab").on("click", (function() {
            var t = "#" + $(this).attr("data-button"),
                e = $(t).parents(".team-grid__content");
            $(this).parents(".button-container");
            console.log("jsTab is clicked"), e.find(".jsTabContent").removeClass("active"), e.find(".button-container").find(".jsTab").removeClass("active"), $(t).addClass("active"), $(this).addClass("active"), $(this).hasClass("btn--bio") ? ($(t).parent().parent().removeClass("active-ind"), $(t).parent().parent().addClass("active-bio")) : ($(t).parent().parent().addClass("active-ind"), $(t).parent().parent().removeClass("active-bio"))
        }))
    }))
}
if ($(".our-designs-carousel").flickity({ cellAlign: "center", contain: !0, prevNextButtons: !0, pageDots: !1, imagesLoaded: !0, wrapAround: !0 }), $(".marketing-page").length, $(".resources-page-2018").length) {
    var imageLazyLoad = new LazyLoad({ elements_selector: ".resources-listing-item img" }),
        iframeLazyLoad = new LazyLoad({ elements_selector: ".wistia_embed" });
    inView(".resources-listing section").on("enter", (function(t) {
        var e = t.id;
        $('a[href="#' + e + '"]').addClass("active")
    })), inView(".resources-listing section").on("exit", (function(t) {
        var e = t.id;
        $('a[href="#' + e + '"]').removeClass("active")
    }))
}
if ($(".portfolio-page").length && $(".portfolio-media-expand").on("click", (function() { $(this).parent().addClass("expanded") })), $("#additional-resources").length) {
    var $recommendedReading = $("#recommended-reading"),
        recommendedReadingEndpoint = $recommendedReading.data("endpoint"),
        $additionalResources = $("#additional-resources"),
        additionalResourcesEndpoint = $additionalResources.data("endpoint");
    $.when($.get(recommendedReadingEndpoint, (function(t) { readingData = t })), $.get(additionalResourcesEndpoint, (function(t) { resourcesData = t }))).then((function() {
        readingData && (readingData.results.forEach((function(t) {
            var e = "<li><a href='" + t.url + "'>" + t.title + "</a></li>";
            $recommendedReading.append(e)
        })), 0 == readingData.results && $recommendedReading.prev().hide()), resourcesData && (resourcesData.results.forEach((function(t) {
            var e = "<li><a href='" + t.url + "'>" + t.title + "</a></li>";
            $additionalResources.append(e)
        })), 0 == resourcesData.results && $additionalResources.prev().hide())
    }))
}
if ($(".case-study-listing-2019").length) {
    $grid = $(".blog-grid").isotope({ itemSelector: ".blog-grid-item", layoutMode: "fitRows" });
    var filters = {};

    function concatValues(t) { var e = ""; for (var i in t) e += t[i]; return e }
    $(".main-post-filter__container").on("click", ".button", (function(t) {
        var e = $(t.currentTarget),
            i = e.parents(".button-group").attr("data-filter-group");
        filters[i] = e.attr("data-filter");
        var n = concatValues(filters);
        $grid.isotope({ filter: n })
    })), $(".button-group").each((function(t, e) {
        var i = $(e);
        i.on("click", "button", (function(t) { i.find(".is-checked").removeClass("is-checked"), $(t.currentTarget).addClass("is-checked") }))
    }))
}
$(".case-study-post-2019").length && ($.fn.isInViewport = function() {
    ...
    $(".adv-stat-callout__chart-wrapper").each((function() {
        $(this).isInViewport() && ($(this).find(".chart").addClass("start"), $(".counter.animate").each((function() {
            var t = $(this),
                e = t.attr("data-count");
            $({ countNum: t.text() }).animate({ countNum: e }, { duration: 3e3, easing: "linear", step: function() { t.text(Math.floor(this.countNum)) }, complete: function() { t.text(this.countNum) } })
        })))
    }))
})));
