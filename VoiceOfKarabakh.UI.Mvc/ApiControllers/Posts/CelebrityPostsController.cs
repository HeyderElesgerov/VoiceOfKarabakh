...
namespace VoiceOfKarabakh.UI.Mvc.Controllers.API
{
    ...
    [ApiController]
    public class CelebrityPostsController : PostsController<Domain.Models.Posts.CelebrityPost>
    {
        public CelebrityPostsController(
            IPostService<Domain.Models.Posts.CelebrityPost> postService,
            ILocalizationService localizationService,
            ISaveFileService saveFileService,
            ILocalizationSetService localizationSetService,
            ICategoryRepository categoryRepository,
            ITagRepository tagRepository,
            IPostRepository<Domain.Models.Posts.CelebrityPost> postRepository,
