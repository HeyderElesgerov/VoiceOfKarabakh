...
namespace VoiceOfKarabakh.Infrastructure.Migrations
{
    ...
    [Migration("20201224105028_AddCardSessionIdColumnToCardItemsTable")]
    partial class AddCardSessionIdColumnToCardItemsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VoiceOfKarabakh.Domain.Models.Donation.Donation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VoiceOfKarabakh.Domain.Models.DonationCategory.DonationCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VoiceOfKarabakh.Domain.Models.Donation_Shopping.Card", b =>
                {
            ...
            modelBuilder.Entity("VoiceOfKarabakh.Domain.Models.Donation_Shopping.CardItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VoiceOfKarabakh.Domain.Models.Donation_Shopping.Session", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VoiceOfKarabakh.Domain.Models.Posts.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VoiceOfKarabakh.Domain.Models.Posts.HistoryPost", b =>
                {
                    b.HasBaseType("VoiceOfKarabakh.Domain.Models.Posts.Post");

                    b.HasDiscriminator().HasValue("HistoryPost");
                });

            modelBuilder.Entity("VoiceOfKarabakh.Domain.Models.Posts.NewsPost", b =>
                {
                    b.HasBaseType("VoiceOfKarabakh.Domain.Models.Posts.Post");
            ...
            modelBuilder.Entity("CategoryPost", b =>
                {
                    ...
                    b.HasOne("VoiceOfKarabakh.Domain.Models.Posts.Post", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VoiceOfKarabakh.Domain.Models.Donation.Donation", b =>
                {
                    ...
                    b.HasOne("VoiceOfKarabakh.Domain.Models.DonationCategory.DonationCategory", "DonationCategory")
                        .WithMany("Donations")
            ...
            modelBuilder.Entity("VoiceOfKarabakh.Domain.Models.Donation_Shopping.Card", b =>
                {
                    b.HasOne("VoiceOfKarabakh.Domain.Models.Donation_Shopping.Session", "Session")
                        .WithOne("Card")
                        .HasForeignKey("VoiceOfKarabakh.Domain.Models.Donation_Shopping.Card", "SessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("VoiceOfKarabakh.Domain.Models.Donation_Shopping.CardItem", b =>
                {
                    b.HasOne("VoiceOfKarabakh.Domain.Models.Donation_Shopping.Card", "Card")
                        .WithMany("CardItems")
                        .HasForeignKey("CardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VoiceOfKarabakh.Domain.Models.Donation.Donation", "Donation")
                        .WithMany()
